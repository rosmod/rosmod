...
__CHEETAH_genTime__ = 1424635767.789338
__CHEETAH_genTimestamp__ = 'Sun Feb 22 14:09:27 2015'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod/code/rosmod_v2/ros_tools/templates/component_hpp.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Feb  9 20:48:34 2015'
...
''')
        for topic in VFFSL(SL,"topics",True): # generated from line 19, col 1
            ...
            write(u'''/''')
            _v = VFFSL(SL,"topic",True) # u'${topic}' on line 20, col 30
            if _v is not None: write(_filter(_v, rawExpr=u'${topic}')) # from line 20, col 30.
            write(u'''.h"
''')
        for service in VFFSL(SL,"services",True): # generated from line 22, col 1
            ...
            write(u'''/''')
            _v = VFFSL(SL,"service",True) # u'${service}' on line 23, col 30
            if _v is not None: write(_filter(_v, rawExpr=u'${service}')) # from line 23, col 30.
            write(u'''.h"
''')
        write(u'''
''')
...
""")
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 44, col 2
            for sub in VFFSL(SL,"subscribers",True): # generated from line 45, col 2
                ...
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 46, col 40
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 46, col 40.
                write(u''' subscriber 
\tvoid ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 47, col 7
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 47, col 7.
                write(u'''_OnOneData(const ''')
                _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 47, col 49
                if _v is not None: write(_filter(_v, rawExpr=u'$package_name')) # from line 47, col 49.
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 47, col 64
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["message_reference"].properties["name"]}')) # from line 47, col 64.
...
\tbool ''')
                _v = VFFSL(SL,"provided",True) # u'${provided}' on line 55, col 7
                if _v is not None: write(_filter(_v, rawExpr=u'${provided}')) # from line 55, col 7.
                write(u'''Callback(''')
                _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 55, col 27
                if _v is not None: write(_filter(_v, rawExpr=u'$package_name')) # from line 55, col 27.
                write(u'''::''')
                _v = VFFSL(SL,"provided",True) # u'$provided' on line 55, col 42
                if _v is not None: write(_filter(_v, rawExpr=u'$provided')) # from line 55, col 42.
                write(u'''::Request  &req,
\t\t''')
                ...
                write(u'''::''')
                _v = VFFSL(SL,"provided",True) # u'$provided' on line 56, col 18
                if _v is not None: write(_filter(_v, rawExpr=u'$provided')) # from line 56, col 18.
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)) > 0: # generated from line 61, col 2
            for timer in VFFSL(SL,"timers",True): # generated from line 62, col 2
                ...
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 63, col 18
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 63, col 18.
                write(u''' timer
\tvoid ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 64, col 7
                if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 64, col 7.
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)) > 0: # generated from line 79, col 2
            for timer in VFFSL(SL,"timers",True): # generated from line 80, col 2
                write(u'''\t// ROS Timer - ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 81, col 17
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 81, col 17.
                write(u'''
\tros::Timer ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 82, col 13
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 82, col 13.
                write(u''';
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 87, col 2
            for sub in VFFSL(SL,"subscribers",True): # generated from line 88, col 2
                ...
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 89, col 22
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 89, col 22.
                write(u'''
\tros::Subscriber ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 90, col 18
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 90, col 18.
                write(u'''; 
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 95, col 2
            for pub in VFFSL(SL,"publishers",True): # generated from line 96, col 2
                ...
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 97, col 21
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 97, col 21.
                write(u'''
\tros::Publisher ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 98, col 17
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 98, col 17.
                write(u''';
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"provided_services",True)) > 0: # generated from line 103, col 2
            for provided in VFFSL(SL,"provided_services",True): # generated from line 104, col 2
                ...
                _v = VFFSL(SL,"provided",True) # u'${provided}' on line 105, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'${provided}')) # from line 105, col 26.
                write(u'''_server
\tros::ServiceServer ''')
                _v = VFFSL(SL,"provided",True) # u'${provided}' on line 106, col 21
                if _v is not None: write(_filter(_v, rawExpr=u'${provided}')) # from line 106, col 21.
                write(u'''_server;
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"required_services",True)) > 0: # generated from line 111, col 2
            for required in VFFSL(SL,"required_services",True): # generated from line 112, col 2
                ...
                _v = VFFSL(SL,"required",True) # u'${required}' on line 113, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'${required}')) # from line 113, col 26.
                write(u'''_client
\tros::ServiceClient ''')
                _v = VFFSL(SL,"required",True) # u'${required}' on line 114, col 21
                if _v is not None: write(_filter(_v, rawExpr=u'${required}')) # from line 114, col 21.
                write(u'''_client;
