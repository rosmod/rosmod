...
class HostsListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by HostsParser#host.
    def enterHost(self, ctx):
        pass

    # Exit a parse tree produced by HostsParser#host.
    ...
    # Enter a parse tree produced by HostsParser#architecture.
    def enterArchitecture(self, ctx):
        pass

    # Exit a parse tree produced by HostsParser#architecture.
    def exitArchitecture(self, ctx):
        pass


    # Enter a parse tree produced by HostsParser#host_name.
