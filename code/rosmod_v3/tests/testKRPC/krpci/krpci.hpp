...
public:
  ...
  bool AutoPilot_get_SASMode(uint64_t AutoPilot_ID, int32& return_value);
  bool AutoPilot_set_SASMode(uint64_t AutoPilot_ID, int32 value);
  bool AutoPilot_get_SpeedMode(uint64_t AutoPilot_ID, int32& return_value);
  bool AutoPilot_set_SpeedMode(uint64_t AutoPilot_ID, int32 value);
  ...
  bool CelestialBody_get_Name(uint64_t CelestialBody_ID, string& return_value);
  ...
  bool Control_GetActionGroup(uint64_t Control_ID, uint32 group, bool& return_value);
  bool Control_SetActionGroup(uint64_t Control_ID, uint32 group, bool state);
  bool Control_ToggleActionGroup(uint64_t Control_ID, uint32 group);
  ...
  bool Control_get_CurrentStage(uint64_t Control_ID, int32& return_value);
  ...
  bool Flight_get_FARStatus(uint64_t Flight_ID, string& return_value);
  ...
  bool DockingPort_get_Name(uint64_t DockingPort_ID, string& return_value);
  bool DockingPort_set_Name(uint64_t DockingPort_ID, string value);
  bool DockingPort_get_State(uint64_t DockingPort_ID, int32& return_value);
  ...
  bool LandingGear_get_State(uint64_t LandingGear_ID, int32& return_value);
  ...
  bool LandingLeg_get_State(uint64_t LandingLeg_ID, int32& return_value);
  ...
  bool Module_HasField(uint64_t Module_ID, string name, bool& return_value);
  bool Module_GetField(uint64_t Module_ID, string name, string& return_value);
  bool Module_HasEvent(uint64_t Module_ID, string name, bool& return_value);
  bool Module_TriggerEvent(uint64_t Module_ID, string name);
  bool Module_HasAction(uint64_t Module_ID, string name, bool& return_value);
  bool Module_SetAction(uint64_t Module_ID, string name, bool value);
  bool Module_get_Name(uint64_t Module_ID, string& return_value);
  ...
  bool Parachute_get_State(uint64_t Parachute_ID, int32& return_value);
  ...
  bool Part_get_Name(uint64_t Part_ID, string& return_value);
  bool Part_get_Title(uint64_t Part_ID, string& return_value);
  ...
  bool Part_get_Stage(uint64_t Part_ID, int32& return_value);
  bool Part_get_DecoupleStage(uint64_t Part_ID, int32& return_value);
  ...
  bool Parts_WithName(uint64_t Parts_ID, string name, std::vector<uint64_t>& return_vector);
  bool Parts_WithTitle(uint64_t Parts_ID, string title, std::vector<uint64_t>& return_vector);
  bool Parts_WithModule(uint64_t Parts_ID, string moduleName, std::vector<uint64_t>& return_vector);
  bool Parts_InStage(uint64_t Parts_ID, int32 stage, std::vector<uint64_t>& return_vector);
  bool Parts_InDecoupleStage(uint64_t Parts_ID, int32 stage, std::vector<uint64_t>& return_vector);
  bool Parts_ModulesWithName(uint64_t Parts_ID, string moduleName, std::vector<uint64_t>& return_vector);
  bool Parts_DockingPortWithName(uint64_t Parts_ID, string name, uint64_t& return_value);
  ...
  bool PartResources_HasResource(uint64_t PartResources_ID, string name, bool& return_value);
  bool PartResources_Max(uint64_t PartResources_ID, string name, float& return_value);
  bool PartResources_Amount(uint64_t PartResources_ID, string name, float& return_value);
  ...
  bool Sensor_get_Value(uint64_t Sensor_ID, string& return_value);
  ...
  bool SolarPanel_get_State(uint64_t SolarPanel_ID, int32& return_value);
  ...
  bool Vessel_get_Name(uint64_t Vessel_ID, string& return_value);
  bool Vessel_set_Name(uint64_t Vessel_ID, string value);
  bool Vessel_get_Type(uint64_t Vessel_ID, int32& return_value);
  bool Vessel_set_Type(uint64_t Vessel_ID, int32 value);
  bool Vessel_get_Situation(uint64_t Vessel_ID, int32& return_value);
  ...
  bool VesselResources_HasResource(uint64_t VesselResources_ID, string name, bool& return_value);
  bool VesselResources_Max(uint64_t VesselResources_ID, string name, int32 stage, bool cumulative, float& return_value);
  bool VesselResources_Amount(uint64_t VesselResources_ID, string name, int32 stage, bool cumulative, float& return_value);
  ...
  bool AddStream(KRPC.Request request, uint32& return_value);
  bool RemoveStream(uint32 id);
protected:
