...
model_dict["Subscriber"] = Meta_Entity(
    parent = "Component", 
    children = [],
    properties = ["name","message_reference","reference","priority","deadline","abstract_business_logic"],
    in_refs = [["Port_Instance","port_reference"]], 
    out_refs = [["Message","project"]])
...
model_dict["Hardware"] = Meta_Entity(
    parent = "rhw", 
    children = [], 
    properties = ["name","ip_address","username","sshkey","deployment_path","init","arch","system_network_profile"],
