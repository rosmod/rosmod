...
model_dict["Hardware"] = Meta_Entity(
    "rhw", 
    [], 
    ["name","ip_address","username","sshkey","deployment_path","init","arch","system_network_profile"],
    [["Node","hardware_reference"]], 
    [])
...
model_dict["Node"] = Meta_Entity(
    "rdp", 
    ["Component_Instance"], 
    ["name","hardware_reference","priority","cmd_args","deployment_path"],
    [], 
    [["Hardware", "parent", "rhw_reference"]])
model_dict["Component_Instance"] = Meta_Entity(
    "Node", 
    ["Port_Instance"], 
    ["name","component_reference","reference","scheduling_scheme", "logging_critical","logging_error","logging_warning","logging_info", "logging_debug"],
    [], 
    [["Component","project"]])
