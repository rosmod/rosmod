...
__CHEETAH_genTime__ = 1430247499.316041
__CHEETAH_genTimestamp__ = 'Tue Apr 28 13:58:19 2015'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod/code/rosmod_v3/src/templates/base_component_hpp.tmpl'
...
''')
        ...
        write(u''' "''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'$package_name' on line 8, col 16
...
''')
        ...
        write(u''' "''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'$package_name' on line 9, col 16
