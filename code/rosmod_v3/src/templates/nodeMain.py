...
__CHEETAH_genTime__ = 1430247499.387762
__CHEETAH_genTimestamp__ = 'Tue Apr 28 13:58:19 2015'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod/code/rosmod_v3/src/templates/nodeMain.tmpl'
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"component_instances",True)) > 0: # generated from line 9, col 1
            for instance in VFSL([locals()]+SL+[globals(), builtin],"component_instances",True): # generated from line 10, col 1
                ...
                write(u'''/''')
                _v = VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["component_reference"],"properties",True)["name"] # u'${instance.properties["component_reference"].properties["name"]}' on line 11, col 30
...
{
    std::string nodeName = "''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"node_name",True) # u'$node_name' on line 24, col 29
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"component_instances",True)) > 0: # generated from line 41, col 5
            for instance in VFSL([locals()]+SL+[globals(), builtin],"component_instances",True): # generated from line 42, col 5
                write(u'''    ''')
                _v = VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["component_reference"],"properties",True)["name"] # u'$instance.properties["component_reference"].properties["name"]' on line 43, col 5
                if _v is not None: write(_filter(_v, rawExpr=u'$instance.properties["component_reference"].properties["name"]')) # from line 43, col 5.
                write(u''' ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["name"] # u'${instance.properties["name"]}' on line 43, col 68
                if _v is not None: write(_filter(_v, rawExpr=u'${instance.properties["name"]}')) # from line 43, col 68.
                write(u'''(hostName, nodeName, "''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["name"] # u'${instance.properties["name"]}' on line 43, col 120
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"component_instances",True)) > 0: # generated from line 48, col 5
            for instance in VFSL([locals()]+SL+[globals(), builtin],"component_instances",True): # generated from line 49, col 5
                write(u'''    boost::thread ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["name"] # u'${instance.properties["name"]}' on line 50, col 19
                if _v is not None: write(_filter(_v, rawExpr=u'${instance.properties["name"]}')) # from line 50, col 19.
                write(u'''_thread(componentThread, &''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["name"] # u'${instance.properties["name"]}' on line 50, col 75
                if _v is not None: write(_filter(_v, rawExpr=u'${instance.properties["name"]}')) # from line 50, col 75.
                write(u''');
    ROS_INFO("Node ''')
                _v = VFSL([locals()]+SL+[globals(), builtin],"node_name",True) # u'${node_name}' on line 51, col 20
                if _v is not None: write(_filter(_v, rawExpr=u'${node_name}')) # from line 51, col 20.
                write(u''' has started ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["name"] # u'${instance.properties["name"]}' on line 51, col 45
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"component_instances",True)) > 0: # generated from line 59, col 5
            for instance in VFSL([locals()]+SL+[globals(), builtin],"component_instances",True): # generated from line 60, col 5
                write(u'''    ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"instance",True),"properties",True)["name"] # u'${instance.properties["name"]}' on line 61, col 5
