...
#include "ksp_aeris_controller/Sensor_Reading.h"
#include "ksp_aeris_controller/Control_Command.h"


//# Start User Includes Marker
#include "ksp_aeris_controller/libpid.hpp"
...
public:
  ...
  void sensor_subscriber_OnOneData(const ksp_aeris_controller::Sensor_Reading::ConstPtr& received_data); 
 
  // Subscriber Callback - pid_control_subscriber
  void pid_control_subscriber_OnOneData(const ksp_aeris_controller::Control_Command::ConstPtr& received_data); 
