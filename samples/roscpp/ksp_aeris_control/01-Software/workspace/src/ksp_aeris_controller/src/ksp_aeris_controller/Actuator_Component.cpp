#include "ksp_aeris_controller/Actuator_Component.hpp"
...
void Actuator_Component::actuator_control_subscriber_OnOneData(const ksp_aeris_controller::Actuation_Command::ConstPtr& received_data)
{
...
void Actuator_Component::startUp()
{
  ...
  actuator_control_subscriber_options = ros::SubscribeOptions::create<ksp_aeris_controller::Actuation_Command>
      (advertiseName.c_str(),
       1000,
