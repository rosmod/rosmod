#include "ksp_aeris_controller/Sensor_Component.hpp"
...
void Sensor_Component::sensor_timerCallback(const ros::TimerEvent& event)
{
  ...
  ksp_aeris_controller::Sensor_Reading new_reading;
...
void Sensor_Component::startUp()
{
  ...
  this->sensor_publisher = nh.advertise<ksp_aeris_controller::Sensor_Reading>(advertiseName.c_str(), 1000);
