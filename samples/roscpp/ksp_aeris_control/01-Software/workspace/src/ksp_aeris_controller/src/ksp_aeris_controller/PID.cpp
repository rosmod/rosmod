#include "ksp_aeris_controller/PID.hpp"
...
void PID::sensor_subscriber_OnOneData(const ksp_aeris_controller::Sensor_Reading::ConstPtr& received_data)
{
...
void PID::pid_control_subscriber_OnOneData(const ksp_aeris_controller::Control_Command::ConstPtr& received_data)
{
...
void PID::pid_timerCallback(const ros::TimerEvent& event)
{
  ...
  ksp_aeris_controller::Actuation_Command new_actuation;
...
void PID::startUp()
{
  ...
  pid_control_subscriber_options = ros::SubscribeOptions::create<ksp_aeris_controller::Control_Command>
      (advertiseName.c_str(),
       1000,
  ...
  this->actuator_control_publisher = nh.advertise<ksp_aeris_controller::Actuation_Command>(advertiseName.c_str(), 1000);
