...
class LowResolutionIMageProducer_def : public Component
{
    public:
        ...
        LowResolutionIMageProducer_def(std::string hostName, std::string nodeName, std::string compName, int argc, char **argv) : Component(hostName, nodeName, compName, argc, argv) {}
