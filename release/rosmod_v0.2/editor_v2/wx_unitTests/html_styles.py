...
# 2011-10-27T23:30:37+02:00 (MitteleuropÃ¤ische Sommerzeit,
#
...
HTML_STYLES = {
    wx.stc.STC_H_DEFAULT: 
        "fore:#000000,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_TAG:
        "fore:#000080,back:#ffffff,face:Courier New,size:10,bold",
    wx.stc.STC_H_TAGUNKNOWN:
        "fore:#ff0000,back:#ffffff,face:Courier New,size:10,bold",
    wx.stc.STC_H_ATTRIBUTE:
        "fore:#0040c0,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_ATTRIBUTEUNKNOWN:
        "fore:#ff0000,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_NUMBER:
        "fore:#cc0000,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_DOUBLESTRING:
        "fore:#7f00bf,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_SINGLESTRING:
        "fore:#7f00bf,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_OTHER:
        "fore:#800080,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_COMMENT:
        "fore:#007f00,back:#eeffee,face:Courier New,size:10",
    wx.stc.STC_H_ENTITY:
        "fore:#336600,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_TAGEND:
        "fore:#000080,back:#ffffff,face:Courier New,size:10,bold",
    wx.stc.STC_H_XMLSTART:
        "fore:#0000ff,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_XMLEND:
        "fore:#0000ff,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_SCRIPT:
        "fore:#000080,back:#ffffff,face:Courier New,size:10",
    wx.stc.STC_H_ASP:
        "fore:#000000,back:#ffff00,face:Courier New,size:10",
    wx.stc.STC_H_ASPAT:
        "fore:#000000,back:#ffdf00,face:Courier New,size:10",
    wx.stc.STC_H_CDATA:
        "fore:#000000,back:#ffdf00,face:Courier New,size:10",
    wx.stc.STC_H_QUESTION:
        "fore:#0000ff,back:#ffefbf,face:Courier New,size:10",
    wx.stc.STC_H_VALUE:
        "fore:#ff00ff,back:#ffefff,face:Courier New,size:10",
    wx.stc.STC_H_XCCOMMENT:
        "fore:#000000,back:#ffffd0,face:Courier New,size:10",
                    
    wx.stc.STC_H_SGML_DEFAULT:
        "fore:#000080,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_COMMAND:
        "fore:#000080,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_1ST_PARAM:
        "fore:#006600,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_DOUBLESTRING:
        "fore:#800000,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_SIMPLESTRING:
        "fore:#993300,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_ERROR:
        "fore:#800000,back:#ff6666,face:Courier New,size:10",
    wx.stc.STC_H_SGML_SPECIAL:
        "fore:#3366ff,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_ENTITY:
        "fore:#333333,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_COMMENT:
        "fore:#808000,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_1ST_PARAM_COMMENT:
        "fore:#808000,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_H_SGML_BLOCK_DEFAULT:
        "fore:#000066,back:#CCCCE0,face:Courier New,size:10",

    wx.stc.STC_HPHP_DEFAULT:
        "fore:#000033,back:#efefff,face:Courier New,size:10,eolfilled",
    wx.stc.STC_HPHP_HSTRING:
        "fore:#bF00bF,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_HPHP_SIMPLESTRING:
        "fore:#009F00,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_HPHP_WORD:
        "fore:#7F007F,back:#efefff,face:Courier New,size:10,bold",
    wx.stc.STC_HPHP_NUMBER:
        "fore:#CC9900,back:#efefff,face:Courier New,size:10",
    wx.stc.STC_HPHP_VARIABLE:
        "fore:#00007F,back:#efefff,face:Courier New,size:10,italics",
    wx.stc.STC_HPHP_COMMENT:
        "fore:#3F7F3F,back:#efffff,face:Courier New,size:10,italics",
    wx.stc.STC_HPHP_COMMENTLINE:
        "fore:#007F00,back:#effffe,face:Courier New,size:10",
    wx.stc.STC_HPHP_HSTRING_VARIABLE:
        "fore:#00007F,back:#efefff,face:Courier New,size:10,italics",
    wx.stc.STC_HPHP_OPERATOR:
        "fore:#660000,back:#efefff,face:Courier New,size:10",

    wx.stc.STC_HJ_START:
        "fore:#000033,back:#ffefef,face:Courier New,size:10,eolfilled",
    wx.stc.STC_HJ_DEFAULT:
        "fore:#7F7F00,back:#ffefef,face:Courier New,size:10,bold,eolfilled",
    wx.stc.STC_HJ_COMMENT:
        "fore:#3F7F3F,back:#ffffef,face:Courier New,size:10,italic",
    wx.stc.STC_HJ_COMMENTLINE:
        "fore:#007F00,back:#effffe,face:Courier New,size:10,italic",
    wx.stc.STC_HJ_COMMENTDOC:
        "fore:#330000,back:#ffdfdf,face:Courier New,size:10,italic",
    wx.stc.STC_HJ_NUMBER:
        "fore:#CC9900,back:#ffefef,face:Courier New,size:10",
    wx.stc.STC_HJ_WORD:
        "fore:#000000,back:#ffefef,face:Courier New,size:10",
    wx.stc.STC_HJ_KEYWORD:
        "fore:#00007f,back:#ffefef,face:Courier New,size:10,bold",
    wx.stc.STC_HJ_DOUBLESTRING:
        "fore:#bF00bF,back:#ffefef,face:Courier New,size:10",
    wx.stc.STC_HJ_SINGLESTRING:
        "fore:#009F00,back:#ffefef,face:Courier New,size:10",
    wx.stc.STC_HJ_SYMBOLS:
        "fore:#660000,back:#ffefef,face:Courier New,size:10,bold",
    wx.stc.STC_HJ_STRINGEOL:
        "fore:#BFBBB0,back:#ffefef,face:Courier New,size:10,eolfilled",
    wx.stc.STC_HJ_REGEX:
        "fore:#660033,back:#ffcfcf,face:Courier New,size:10",
}

def style_control(ctrl):
    for key, value in HTML_STYLES.iteritems():
