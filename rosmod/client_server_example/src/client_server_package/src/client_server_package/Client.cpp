...
//# Start Init Marker
void Client::Init(const rosmod::TimerEvent& event)
{
...
void Client::client_timerCallback(const rosmod::TimerEvent& event)
{
  compQueue.ROSMOD_LOGGER.DEBUG("Entering client_timerCallback");
  ...
  compQueue.ROSMOD_LOGGER.DEBUG("Exiting client_timerCallback");
}
...
void Client::startUp()
{
  ...
  callback_options.alias = "Client_Timer";
