...
__CHEETAH_genTime__ = 1456002507.538043
__CHEETAH_genTimestamp__ = 'Sat Feb 20 15:08:27 2016'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod/gui/templates/rdp.tmpl'
...
\t{
''')
                        if VFN(VFSL([locals()]+SL+[globals(), builtin],"comp_instance",True),"properties",True)["is_periodic_logging"] != False: # generated from line 31, col 1
                            write(u'''\t  Is Periodic? = true;
''')
                        else: # generated from line 33, col 1
                            write(u'''\t  Is Periodic? = false;
''')
                        if VFN(VFSL([locals()]+SL+[globals(), builtin],"comp_instance",True),"properties",True)["periodic_log_unit"] != None: # generated from line 36, col 1
                            write(u'''\t  Periodic Log Unit = ''')
                            _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"comp_instance",True),"properties",True)["periodic_log_unit"] # u'$comp_instance.properties["periodic_log_unit"]' on line 37, col 24
                            if _v is not None: write(_filter(_v, rawExpr=u'$comp_instance.properties["periodic_log_unit"]')) # from line 37, col 24.
                            write(u''';
''')
                        else: # generated from line 38, col 1
                            write(u'''\t  Periodic Log Unit = ''')
                            _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"comp_instance",True),"properties",True)["periodic_log_unit"] # u'$comp_instance.properties["periodic_log_unit"]' on line 39, col 24
                            if _v is not None: write(_filter(_v, rawExpr=u'$comp_instance.properties["periodic_log_unit"]')) # from line 39, col 24.
                            write(u''';
''')
                        write(u'''\t}
      }
''')
                        if VFSL([locals()]+SL+[globals(), builtin],"comp_instance.children",True) != []: # generated from line 43, col 1
                            for port_instance in VFSL([locals()]+SL+[globals(), builtin],"comp_instance.children",True): # generated from line 44, col 1
                                ...
                                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["name"] # u'$port_instance.properties["name"]' on line 45, col 21
                                if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["name"]')) # from line 45, col 21.
                                write(u''' 
      {
\tref = "''')
                                _v = VFN(VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["port_reference"],"parent",True),"properties",True)["name"] # u'$port_instance.properties["port_reference"].parent.properties["name"]' on line 47, col 9
                                if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["port_reference"].parent.properties["name"]')) # from line 47, col 9.
                                write(u'''/''')
                                _v = VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["port_reference"],"properties",True)["name"] # u'$port_instance.properties["port_reference"].properties["name"]' on line 47, col 79
                                if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["port_reference"].properties["name"]')) # from line 47, col 79.
                                write(u'''";
\tgroup = "''')
                                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["group"] # u'$port_instance.properties["group"]' on line 48, col 11
                                if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["group"]')) # from line 48, col 11.
                                write(u'''";
      }
''')
                        write(u'''  }
