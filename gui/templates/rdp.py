...
__CHEETAH_genTime__ = 1456155351.212347
...
\t{
''')
                        if VFN(VFFSL(SL,"comp_instance",True),"properties",True)["is_periodic_logging"] != False: # generated from line 31, col 1
                            write(u'''\t  Is Periodic? = true;
''')
                        else: # generated from line 33, col 1
                            write(u'''\t  Is Periodic? = false;
''')
                        if VFN(VFFSL(SL,"comp_instance",True),"properties",True)["periodic_log_unit"] != None: # generated from line 36, col 1
                            write(u'''\t  Periodic Log Unit = ''')
                            _v = VFN(VFFSL(SL,"comp_instance",True),"properties",True)["periodic_log_unit"] # u'$comp_instance.properties["periodic_log_unit"]' on line 37, col 24
...
''')
                            ...
                            write(u'''\t  Periodic Log Unit = ''')
                            _v = VFN(VFFSL(SL,"comp_instance",True),"properties",True)["periodic_log_unit"] # u'$comp_instance.properties["periodic_log_unit"]' on line 39, col 24
...
''')
                        if VFFSL(SL,"comp_instance.children",True) != []: # generated from line 43, col 1
                            for port_instance in VFFSL(SL,"comp_instance.children",True): # generated from line 44, col 1
                                ...
                                _v = VFN(VFFSL(SL,"port_instance",True),"properties",True)["name"] # u'$port_instance.properties["name"]' on line 45, col 21
                                if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["name"]')) # from line 45, col 21.
                                write(u''' 
      {
\tref = "''')
                                _v = VFN(VFN(VFN(VFFSL(SL,"port_instance",True),"properties",True)["port_reference"],"parent",True),"properties",True)["name"] # u'$port_instance.properties["port_reference"].parent.properties["name"]' on line 47, col 9
                                ...
                                write(u'''/''')
                                _v = VFN(VFN(VFFSL(SL,"port_instance",True),"properties",True)["port_reference"],"properties",True)["name"] # u'$port_instance.properties["port_reference"].properties["name"]' on line 47, col 79
                                if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["port_reference"].properties["name"]')) # from line 47, col 79.
                                write(u'''";
\tgroup = "''')
                                _v = VFN(VFFSL(SL,"port_instance",True),"properties",True)["group"] # u'$port_instance.properties["group"]' on line 48, col 11
