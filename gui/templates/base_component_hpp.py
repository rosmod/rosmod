...
__CHEETAH_genTime__ = 1455646683.659361
...
#ifdef USE_ROSMOD
  ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"hash_include",True) # u'$hash_include' on line 11, col 3
        if _v is not None: write(_filter(_v, rawExpr=u'$hash_include')) # from line 11, col 3.
        write(u''' "rosmod/rosmod_ros.h"
  ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"hash_include",True) # u'$hash_include' on line 12, col 3
        if _v is not None: write(_filter(_v, rawExpr=u'$hash_include')) # from line 12, col 3.
        write(u''' "rosmod/rosmod_callback_queue.h"
#else
  #ifdef USE_ROSCPP
    ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"hash_include",True) # u'$hash_include' on line 15, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$hash_include')) # from line 15, col 5.
        write(u''' "ros/ros.h"
    ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"hash_include",True) # u'$hash_include' on line 16, col 5
