...
__CHEETAH_genTime__ = 1455822786.204294
...
__CHEETAH_srcLastModified__ = 'Wed Feb 17 08:11:31 2016'
...
\t''')
      ...
      fName = config.nodeName + "." + config.compName + ".''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 149, col 59
...
#endif 
  this->''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 503, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 503, col 9.
                write(u''' = nh.subscribe(''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 503, col 50
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 503, col 50.
                write(u'''_options);
''')
        write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"required_services",True)) > 0: # generated from line 507, col 1
            write(u'''  // Configure all required services associated with this component
''')
            for client in VFFSL(SL,"clients",True): # generated from line 509, col 1
                write(u'''  // Component Client - ''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 510, col 25
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 510, col 25.
                write(u'''
  advertiseName = "''')
                _v = VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$client.properties["service_reference"].properties["name"]' on line 511, col 20
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["service_reference"].properties["name"]')) # from line 511, col 20.
                write(u'''";
  if (config.portGroupMap.find("''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 512, col 33
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 512, col 33.
                write(u'''") != config.portGroupMap.end())
    advertiseName += "_" + config.portGroupMap["''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 513, col 49
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 513, col 49.
                write(u'''"];
  this->''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'${client.properties["name"]}' on line 514, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'${client.properties["name"]}')) # from line 514, col 9.
                write(u''' = nh.serviceClient<''')
                _v = VFN(VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$client.properties["service_reference"].parent.properties["name"]' on line 514, col 57
                ...
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$client.properties["service_reference"].properties["name"]' on line 514, col 124
...
''')
  ...
  timer_options = 
    ...
    (ros::Duration(-1),
     boost::bind(&''')
        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 529, col 19
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 538, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 539, col 1
                write(u'''#ifdef USE_ROSMOD   
  callback_options.alias = "''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 541, col 29
                if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 541, col 29.
                write(u'''_operation";
  callback_options.priority = ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["priority"] # u'$timer.properties["priority"]' on line 542, col 31
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["priority"]')) # from line 542, col 31.
                write(u''';
  callback_options.deadline.sec = ''')
                _v = VFFSL(SL,"int",False)(str(timer.properties["deadline"]).split('.')[0]) # u'${int(str(timer.properties["deadline"]).split(\'.\')[0])}' on line 543, col 35
                if _v is not None: write(_filter(_v, rawExpr=u'${int(str(timer.properties["deadline"]).split(\'.\')[0])}')) # from line 543, col 35.
                write(u''';
  callback_options.deadline.nsec = ''')
                _v = VFFSL(SL,"int",False)(float('0.' + (str(timer.properties["deadline"]).split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (str(timer.properties["deadline"]).split(\'.\')[1]))*1000000000)}' on line 544, col 36
...
#endif
  // Component Timer - ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 546, col 24
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 546, col 24.
                write(u'''
  timer_options = 
    NAMESPACE::TimerOptions
''')
                if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 549, col 1
                    write(u'''    (ros::Duration(-1),
''')
                else: # generated from line 551, col 1
                    write(u'''    (ros::Duration(''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["period"] # u'$timer.properties["period"]' on line 552, col 20
...
''')
                ...
                write(u'''::''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 554, col 36
                if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 554, col 36.
                write(u'''_operation, this, _1),
''')
                if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 555, col 1
...
''')
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 570, col 9
...
''')
        write(u'''
''')
        if VFFSL(SL,"component_type",True) == "KSP": # generated from line 574, col 1
            write(u'''  krpci_client.SetName(config.nodeName + "_" + config.compName);
''')
        write(u'''
  this->init_timer.start();
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 579, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 580, col 1
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 581, col 9
...
extern "C" {
  Component *maker(ComponentConfig &config, int argc, char **argv) {
    return new ''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 588, col 16
