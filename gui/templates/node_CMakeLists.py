...
__CHEETAH_genTime__ = 1456002507.371368
...
ADD_DEFINITIONS(-DNAMESPACE=''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"NAMESPACE",True) # u'${NAMESPACE}' on line 17, col 29
        if _v is not None: write(_filter(_v, rawExpr=u'${NAMESPACE}')) # from line 17, col 29.
        write(u''')
MESSAGE(STATUS ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"NAMESPACE",True) # u'${NAMESPACE}' on line 18, col 16
        if _v is not None: write(_filter(_v, rawExpr=u'${NAMESPACE}')) # from line 18, col 16.
        write(u''')
if (''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"NAMESPACE",True) # u'${NAMESPACE}' on line 19, col 5
...
ELSEIF(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"NAMESPACE",True) # u'${NAMESPACE}' on line 22, col 8
...
#  LIBRARIES ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'$package_name' on line 94, col 14
...
include_directories(
  ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"catkin_INCLUDE_DIRS",True) # u'${catkin_INCLUDE_DIRS}' on line 108, col 3
...
# add_library(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'$package_name' on line 112, col 15
        if _v is not None: write(_filter(_v, rawExpr=u'$package_name')) # from line 112, col 15.
        write(u'''
#   src/''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"PROJECT_NAME",True) # u'${PROJECT_NAME}' on line 113, col 9
        if _v is not None: write(_filter(_v, rawExpr=u'${PROJECT_NAME}')) # from line 113, col 9.
        write(u'''/''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 113, col 25
...
# add_executable(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 117, col 18
        if _v is not None: write(_filter(_v, rawExpr=u'${package_name}')) # from line 117, col 18.
        write(u'''_node src/''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 117, col 43
...
# add_dependencies(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 121, col 20
        if _v is not None: write(_filter(_v, rawExpr=u'${package_name}')) # from line 121, col 20.
        write(u'''_node ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 121, col 41
...
# target_link_libraries(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 124, col 25
        if _v is not None: write(_filter(_v, rawExpr=u'${package_name}')) # from line 124, col 25.
        write(u'''_node
#   ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"catkin_LIBRARIES",True) # u'${catkin_LIBRARIES}' on line 125, col 5
...
#   DESTINATION ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"CATKIN_PACKAGE_BIN_DESTINATION",True) # u'${CATKIN_PACKAGE_BIN_DESTINATION}' on line 139, col 17
...
# install(TARGETS ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'$package_name' on line 143, col 19
        if _v is not None: write(_filter(_v, rawExpr=u'$package_name')) # from line 143, col 19.
        write(u''' ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 143, col 33
        if _v is not None: write(_filter(_v, rawExpr=u'${package_name}')) # from line 143, col 33.
        write(u'''_node
#   ARCHIVE DESTINATION ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"CATKIN_PACKAGE_LIB_DESTINATION",True) # u'${CATKIN_PACKAGE_LIB_DESTINATION}' on line 144, col 25
...
#   LIBRARY DESTINATION ''')
        ...
        write(u'''
#   RUNTIME DESTINATION ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"CATKIN_PACKAGE_BIN_DESTINATION",True) # u'${CATKIN_PACKAGE_BIN_DESTINATION}' on line 146, col 25
...
# install(DIRECTORY include/''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"PROJECT_NAME",True) # u'${PROJECT_NAME}' on line 150, col 29
        if _v is not None: write(_filter(_v, rawExpr=u'${PROJECT_NAME}')) # from line 150, col 29.
        write(u'''/
#   DESTINATION ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"CATKIN_PACKAGE_INCLUDE_DESTINATION",True) # u'${CATKIN_PACKAGE_INCLUDE_DESTINATION}' on line 151, col 17
...
#   # myfile2
#   DESTINATION ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"CATKIN_PACKAGE_SHARE_DESTINATION",True) # u'${CATKIN_PACKAGE_SHARE_DESTINATION}' on line 160, col 17
...
# catkin_add_gtest(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"PROJECT_NAME",True) # u'${PROJECT_NAME}' on line 168, col 20
        if _v is not None: write(_filter(_v, rawExpr=u'${PROJECT_NAME}')) # from line 168, col 20.
        write(u'''-test test/test_''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"package_name",True) # u'${package_name}' on line 168, col 51
        if _v is not None: write(_filter(_v, rawExpr=u'${package_name}')) # from line 168, col 51.
        write(u'''.cpp)
# if(TARGET ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"PROJECT_NAME",True) # u'${PROJECT_NAME}' on line 169, col 13
        if _v is not None: write(_filter(_v, rawExpr=u'${PROJECT_NAME}')) # from line 169, col 13.
        write(u'''-test)
#   target_link_libraries(''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"PROJECT_NAME",True) # u'${PROJECT_NAME}' on line 170, col 27
        if _v is not None: write(_filter(_v, rawExpr=u'${PROJECT_NAME}')) # from line 170, col 27.
        write(u'''-test ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"PROJECT_NAME",True) # u'${PROJECT_NAME}' on line 170, col 48
...
include_directories(include ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"catkin_INCLUDE_DIRS",True) # u'${catkin_INCLUDE_DIRS}' on line 175, col 29
...
target_link_libraries(node_main dl ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"catkin_LIBRARIES",True) # u'${catkin_LIBRARIES}' on line 179, col 36
