...
__CHEETAH_genTime__ = 1456155350.944549
...
''')
        for topic in VFFSL(SL,"topics",True): # generated from line 4, col 1
            ...
            write(u''' "''')
            _v = VFFSL(SL,"topic",True)[0] # u'$topic[0]' on line 5, col 16
            if _v is not None: write(_filter(_v, rawExpr=u'$topic[0]')) # from line 5, col 16.
            write(u'''/''')
            _v = VFFSL(SL,"topic",True)[1] # u'${topic[1]}' on line 5, col 26
            if _v is not None: write(_filter(_v, rawExpr=u'${topic[1]}')) # from line 5, col 26.
            write(u'''.h"
''')
        for service in VFFSL(SL,"services",True): # generated from line 7, col 1
            ...
            write(u''' "''')
            _v = VFFSL(SL,"service",True)[0] # u'$service[0]' on line 8, col 16
            if _v is not None: write(_filter(_v, rawExpr=u'$service[0]')) # from line 8, col 16.
            write(u'''/''')
            _v = VFFSL(SL,"service",True)[1] # u'${service[1]}' on line 8, col 28
...
''')
        if VFFSL(SL,"component_type",True) == 'KSP': # generated from line 19, col 1
...
''')
        if VFFSL(SL,"component_type",True) == 'SUMO': # generated from line 22, col 1
...
''')
        write(u'''
''')
        if VFFSL(SL,"trafficGen",True): # generated from line 26, col 1
            if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 27, col 1
...
''')
            if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 30, col 1
                _v = VFFSL(SL,"hash_include",True) # u'$hash_include' on line 31, col 1
                if _v is not None: write(_filter(_v, rawExpr=u'$hash_include')) # from line 31, col 1.
                write(u''' "network/receiver.hpp"
''')
        write(u'''
''')
        if VFFSL(SL,"user_includes",True) == "": # generated from line 35, col 1
...
''')
            ...
            write(u'''//# Start User Includes Marker
''')
            _v = VFFSL(SL,"user_includes",True) # u'$user_includes' on line 40, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$user_includes')) # from line 40, col 1.
            write(u'''//# End User Includes Marker
''')
        write(u'''
''')
        if VFFSL(SL,"hpp_globals",True) == "": # generated from line 43, col 1
...
''')
            ...
            write(u'''//# Start User Globals Marker
''')
            _v = VFFSL(SL,"hpp_globals",True) # u'$hpp_globals' on line 48, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$hpp_globals')) # from line 48, col 1.
            write(u'''//# End User Globals Marker
''')
        write(u'''
class ''')
        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 51, col 7
...
public:
  // Constructor
  ''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 55, col 3
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 61, col 1
            for sub in VFFSL(SL,"subscribers",True): # generated from line 62, col 1
                write(u'''  // Subscriber Operation - ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 63, col 29
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 63, col 29.
                write(u'''
  void ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 64, col 8
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 64, col 8.
                write(u'''_operation(const ''')
                _v = VFN(VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$sub.properties["message_reference"].parent.properties["name"]' on line 64, col 50
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["message_reference"].parent.properties["name"]')) # from line 64, col 50.
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 64, col 114
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"provided_services",True)) > 0: # generated from line 68, col 1
            for server in VFFSL(SL,"servers",True): # generated from line 69, col 1
                write(u'''  // Server Operation - ''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'$server.properties["name"]' on line 70, col 25
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["name"]')) # from line 70, col 25.
                write(u'''
  bool ''')
                _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 71, col 8
                if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 71, col 8.
                write(u'''_operation(''')
                _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 71, col 79
                ...
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 71, col 146
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["service_reference"].properties["name"]')) # from line 71, col 146.
                write(u'''::Request &req, 
    ''')
                _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 72, col 5
                ...
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 72, col 72
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)) > 0: # generated from line 76, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 77, col 1
                write(u'''  // Timer Operation - ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 78, col 24
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 78, col 24.
                write(u'''
  void ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 79, col 8
...
''')
  ...
  // Destructor
  ~''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 87, col 4
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)) > 0: # generated from line 91, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 92, col 1
                write(u'''  // Timer
  NAMESPACE::Timer ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 94, col 20
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 94, col 20.
                write(u''';

''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 98, col 1
...
''')
            for sub in VFFSL(SL,"subscribers",True): # generated from line 103, col 1
                write(u'''  // Subscriber
  NAMESPACE::Subscriber ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 105, col 25
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 105, col 25.
                write(u''';
''')
                if VFFSL(SL,"trafficGen",True): # generated from line 106, col 1
                    write(u'''  // message id for this data stream
  uint64_t ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 108, col 12
                    if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 108, col 12.
                    write(u'''_id;
  // subscriber receiver middleware
  Network::receiver ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 110, col 21
                    if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 110, col 21.
                    write(u'''_recv_mw;
''')
                write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 115, col 1
            if VFFSL(SL,"trafficGen",True): # generated from line 116, col 1
                write(u'''  // do we abide by the profiles?
  bool tg_misbehave;
  // size of messages generated
  uint64_t max_data_length;
''')
            for pub in VFFSL(SL,"publishers",True): # generated from line 122, col 1
                write(u'''  // Publisher 
  NAMESPACE::Publisher ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 124, col 24
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 124, col 24.
                write(u''';
''')
                if VFFSL(SL,"trafficGen",True): # generated from line 125, col 1
                    write(u'''  // Timer for generating traffic
  NAMESPACE::Timer ''')
                    _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 127, col 20
  ...
  void ''')
                    _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 129, col 8
  ...
  Network::sender ''')
                    _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 131, col 19
                    if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 131, col 19.
                    write(u'''_send_mw;
''')
                write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"provided_services",True)) > 0: # generated from line 136, col 1
            for server in VFFSL(SL,"servers",True): # generated from line 137, col 1
                write(u'''  // Server 
  NAMESPACE::ServiceServer ''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 139, col 28
                if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 139, col 28.
                write(u''';

''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"required_services",True)) > 0: # generated from line 143, col 1
            for client in VFFSL(SL,"clients",True): # generated from line 144, col 1
                write(u'''  // Client 
  NAMESPACE::ServiceClient ''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 146, col 28
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 146, col 28.
                write(u''';

''')
        if VFFSL(SL,"user_private_variables",True) == "": # generated from line 150, col 1
...
''')
            ...
            write(u'''  //# Start User Private Variables Marker
''')
            _v = VFFSL(SL,"user_private_variables",True) # u'$user_private_variables' on line 155, col 1
