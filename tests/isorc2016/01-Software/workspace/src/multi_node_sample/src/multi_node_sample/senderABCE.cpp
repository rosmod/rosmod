...
//# Start Init Marker
void senderABCE::init_timer_operation(const NAMESPACE::TimerEvent& event)
{
#ifdef USE_ROSMOD
  ...
  init_timer.stop();
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Exiting senderABCE::init_timer_operation");
#endif  
}
//# End Init Marker
...
void senderABCE::startUp()
{
  ...
  comp_sync_sub_options = NAMESPACE::SubscribeOptions::create<std_msgs::Bool>
    ("component_synchronization",
     1000,
     boost::bind(&senderABCE::component_sync_operation, this, _1),
     NAMESPACE::VoidPtr(),
#ifdef USE_ROSMOD     
     &this->comp_queue,
  ...
  timer_options = 
    ...
    (ros::Duration(-1),
     boost::bind(&senderABCE::init_timer_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif     
  ...
  timer_options = 
    NAMESPACE::TimerOptions
    (ros::Duration(0.05),
     boost::bind(&senderABCE::timerA_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif 
  ...
  timer_options = 
    NAMESPACE::TimerOptions
    (ros::Duration(0.06),
     boost::bind(&senderABCE::timerB_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif 
  ...
  timer_options = 
    NAMESPACE::TimerOptions
    (ros::Duration(0.07),
     boost::bind(&senderABCE::timerC_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif 
  ...
  timer_options = 
    NAMESPACE::TimerOptions
    (ros::Duration(0.08),
     boost::bind(&senderABCE::timerE_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif 
...
extern "C" {
  Component *maker(ComponentConfig &config, int argc, char **argv) {
    return new senderABCE(config,argc,argv);
  }
}
