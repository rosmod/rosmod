...
class ROSMOD_Log_Plotter():
    ...
    def plot(self, opn_max, combined, directory):
        ...
        for call in self.unique_callbacks:
            ...
            for instance in calls:
                if opn_max == 'all' or count <= int(opn_max):
                    x_axis.extend([instance.enqueue_time - x_min, instance.enqueue_time - x_min,
                                   instance.completion_time - x_min, instance.completion_time - x_min])
            ...
            pylab.xlim([x_min-x_min, x_max-x_min])
