...
//# Start Init Marker
void Component_5::init_timer_operation(const NAMESPACE::TimerEvent& event)
{
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Entering Component_5::init_timer_operation");
#endif
  // Initialize Here
  // Stop Init Timer
  init_timer.stop();
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Exiting Component_5::init_timer_operation");
#endif  
}
//# End Init Marker
...
#pragma optimize( "", off )
void Component_5::Timer_5_operation(const NAMESPACE::TimerEvent& event)
{
#ifdef USE_ROSMOD
...
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Exiting Component_5::Timer_5_operation");
#endif
}
#pragma optimize( "", on )
...
void Component_5::startUp()
{
  ...
  comp_sync_sub_options = NAMESPACE::SubscribeOptions::create<std_msgs::Bool>
    ("component_synchronization",
     1000,
     boost::bind(&Component_5::component_sync_operation, this, _1),
     NAMESPACE::VoidPtr(),
#ifdef USE_ROSMOD     
     &this->comp_queue,
  ...
  timer_options = 
    ...
    (ros::Duration(-1),
     boost::bind(&Component_5::init_timer_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif     
  ...
  timer_options = 
    NAMESPACE::TimerOptions
    (ros::Duration(0.1),
     boost::bind(&Component_5::Timer_5_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif 
...
extern "C" {
  Component *maker(ComponentConfig &config, int argc, char **argv) {
    return new Component_5(config,argc,argv);
  }
}
