...
//# Start Init Marker
void high_level_controller::init_timer_operation(const NAMESPACE::TimerEvent& event)
{
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Entering high_level_controller::init_timer_operation");
#endif
  // Initialize Here
  goal_heading = 90.0;
  current_state = INIT;
  ...
  init_timer.stop();
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Exiting high_level_controller::init_timer_operation");
#endif  
}
//# End Init Marker
...
void high_level_controller::vessel_state_sub_operation(const rover_pkg::vessel_state::ConstPtr& received_data)
{
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Entering high_level_controller::vessel_state_sub_operation");
#endif
...
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Exiting high_level_controller::vessel_state_sub_operation");
#endif
}
//# End vessel_state_sub_operation Marker

// Timer Callback - state_timer
//# Start state_timer_operation Marker
void high_level_controller::state_timer_operation(const NAMESPACE::TimerEvent& event)
{
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Entering high_level_controller::state_timer_operation");
#endif
  // Business Logic for state_timer_operation
...
#ifdef USE_ROSMOD
  comp_queue.ROSMOD_LOGGER->log("DEBUG", "Exiting high_level_controller::state_timer_operation");
#endif
}
//# End state_timer_operation Marker
...
void high_level_controller::startUp()
{
  ...
  if (config.portGroupMap.find("goal_state_pub") != config.portGroupMap.end())
    advertiseName += "_" + config.portGroupMap["goal_state_pub"];
  ...
  comp_sync_sub_options = NAMESPACE::SubscribeOptions::create<std_msgs::Bool>
    ("component_synchronization",
     1000,
     boost::bind(&high_level_controller::component_sync_operation, this, _1),
     NAMESPACE::VoidPtr(),
#ifdef USE_ROSMOD     
     &this->comp_queue,
  ...
  vessel_state_sub_options = NAMESPACE::SubscribeOptions::create<rover_pkg::vessel_state>
      (advertiseName.c_str(),
       1000,
       boost::bind(&high_level_controller::vessel_state_sub_operation, this, _1),
       NAMESPACE::VoidPtr(),
#ifdef USE_ROSMOD
       &this->comp_queue,
       callback_options);
  ...
  timer_options = 
    ...
    (ros::Duration(-1),
     boost::bind(&high_level_controller::init_timer_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif     
...
#ifdef USE_ROSMOD   
  callback_options.alias = "state_timer_operation";
  callback_options.priority = 50;
  callback_options.deadline.sec = 0;
  callback_options.deadline.nsec = 100000000;
#endif
  ...
  timer_options = 
    NAMESPACE::TimerOptions
    (ros::Duration(0.5),
     boost::bind(&high_level_controller::state_timer_operation, this, _1),
     &this->comp_queue,
#ifdef USE_ROSMOD     
     callback_options,
#endif 
