#include "publish_subscribe_package/Component_1.hpp"
...
void Component_1::subscriber_port_OnOneData(const publish_subscribe_package::Message::ConstPtr& received_data)
{
...
void Component_1::startUp()
{
  ...
  subscriber_port_options = ros::SubscribeOptions::create<publish_subscribe_package::Message>
      (advertiseName.c_str(),
       1000,
       boost::bind(&Component_1::subscriber_port_OnOneData, this, _1),
       ros::VoidPtr(),
       &this->compQueue);
