#include "ten_component/Main_Controller.hpp"
...
void Main_Controller::sensor_state_subscriber_operation(const ten_component::sensor_state::ConstPtr& received_data)
{
#ifdef USE_ROSMOD
  ...
  ten_component::control_command new_command;
...
void Main_Controller::startUp()
{
  ...
  this->control_command_publisher = nh.advertise<ten_component::control_command>(advertiseName.c_str(), 1000);
  ...
  sensor_state_subscriber_options = NAMESPACE::SubscribeOptions::create<ten_component::sensor_state>
      (advertiseName.c_str(),
       1000,
