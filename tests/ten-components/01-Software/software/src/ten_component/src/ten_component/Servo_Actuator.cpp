#include "ten_component/Servo_Actuator.hpp"
...
void Servo_Actuator::control_command_subscriber_operation(const ten_component::control_command::ConstPtr& received_data)
{
#ifdef USE_ROSMOD
  ...
  boost::random::uniform_int_distribution<> loop_iteration_random(7500 * 0.6, 7500);
...
void Servo_Actuator::startUp()
{
  ...
  control_command_subscriber_options = NAMESPACE::SubscribeOptions::create<ten_component::control_command>
      (advertiseName.c_str(),
       1000,
