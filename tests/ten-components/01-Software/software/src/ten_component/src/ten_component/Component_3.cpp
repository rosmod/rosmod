#include "ten_component/Component_3.hpp"
...
void Component_3::Timer_3_operation(const NAMESPACE::TimerEvent& event)
{
  ...
  ten_component::ComponentService srv;
...
void Component_3::startUp()
{
  ...
  this->Service_Client = nh.serviceClient<ten_component::ComponentService>(advertiseName.c_str(), true); 
