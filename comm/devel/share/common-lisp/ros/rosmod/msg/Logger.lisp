...
(cl:defmethod cl:initialize-instance :after ((m <Logger>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Logger)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosmod-msg:<Logger> is deprecated: use rosmod-msg:Logger instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Logger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosmod-msg:name-val is deprecated.  Use rosmod-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'level-val :lambda-list '(m))
(cl:defmethod level-val ((m <Logger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosmod-msg:level-val is deprecated.  Use rosmod-msg:level instead.")
  (level m))
