...
(cl:defmethod cl:initialize-instance :after ((m <SetLoggerLevel-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLoggerLevel-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosmod-srv:<SetLoggerLevel-request> is deprecated: use rosmod-srv:SetLoggerLevel-request instead.")))

(cl:ensure-generic-function 'logger-val :lambda-list '(m))
(cl:defmethod logger-val ((m <SetLoggerLevel-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosmod-srv:logger-val is deprecated.  Use rosmod-srv:logger instead.")
  (logger m))

(cl:ensure-generic-function 'level-val :lambda-list '(m))
(cl:defmethod level-val ((m <SetLoggerLevel-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosmod-srv:level-val is deprecated.  Use rosmod-srv:level instead.")
  (level m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetLoggerLevel-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLoggerLevel-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosmod-srv:<SetLoggerLevel-response> is deprecated: use rosmod-srv:SetLoggerLevel-response instead.")))
