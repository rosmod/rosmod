...
(cl:defmethod cl:initialize-instance :after ((m <GetLoggers-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLoggers-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosmod-srv:<GetLoggers-request> is deprecated: use rosmod-srv:GetLoggers-request instead.")))
...
(cl:defclass <GetLoggers-response> (roslisp-msg-protocol:ros-message)
  ((loggers
    :reader loggers
    :initarg :loggers
    :type (cl:vector rosmod-msg:Logger)
   :initform (cl:make-array 0 :element-type 'rosmod-msg:Logger :initial-element (cl:make-instance 'rosmod-msg:Logger))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetLoggers-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLoggers-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosmod-srv:<GetLoggers-response> is deprecated: use rosmod-srv:GetLoggers-response instead.")))

(cl:ensure-generic-function 'loggers-val :lambda-list '(m))
(cl:defmethod loggers-val ((m <GetLoggers-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosmod-srv:loggers-val is deprecated.  Use rosmod-srv:loggers instead.")
  (loggers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetLoggers-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'loggers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosmod-msg:Logger))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLoggers-response>)))
  ...
  (cl:format cl:nil "Logger[] loggers~%~%================================================================================~%MSG: rosmod/Logger~%string name~%string level~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLoggers-response)))
  "Returns full string definition for message of type 'GetLoggers-response"
  (cl:format cl:nil "Logger[] loggers~%~%================================================================================~%MSG: rosmod/Logger~%string name~%string level~%~%~%"))
