...
rosbuild_find_ros_package(rosmod)
...
macro(genmsg_cpp)
  ...
  foreach(_msg ${_msglist})
    ...
    set(genmsg_cpp_exe ${rosmod_PACKAGE_PATH}/rosbuild/scripts/genmsg_cpp.py)
...
macro(gensrv_cpp)
  ...
  foreach(_srv ${_srvlist})
    ...
    set(gensrv_cpp_exe ${rosmod_PACKAGE_PATH}/rosbuild/scripts/gensrv_cpp.py)
    set(genmsg_cpp_exe ${rosmod_PACKAGE_PATH}/rosbuild/scripts/genmsg_cpp.py)
