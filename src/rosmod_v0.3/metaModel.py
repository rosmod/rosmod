...
model_dict["rhw"] = Meta_Entity(
    parent = "Project", 
    children = ["Hardware"], 
    properties = ["name","system_network_profile"],
...
model_dict["Component_Instance"] = Meta_Entity(
    ...
    properties = ["name","component_reference","reference","scheduling_scheme", "is_periodic_logging", "periodic_log_unit", "logging_critical","logging_error","logging_warning","logging_info", "logging_debug"],
    in_refs = [], 
