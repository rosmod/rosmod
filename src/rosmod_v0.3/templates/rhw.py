...
__CHEETAH_genTime__ = 1437152919.360315
                ...
                write(u'''
{
  ...
  deployment_path = "''')
                ...
                write(u'''";
''')
                if VFN(VFFSL(SL,"hardware",True),"properties",True)["init"] != "": # generated from line 14, col 1
                    write(u'''  init = "''')
                    _v = VFN(VFFSL(SL,"hardware",True),"properties",True)["init"] # u'$hardware.properties["init"]' on line 15, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'$hardware.properties["init"]')) # from line 15, col 11.
                    write(u'''";
''')
                if VFN(VFFSL(SL,"hardware",True),"properties",True)["arch"] != "": # generated from line 17, col 1
                    write(u'''  arch = ''')
                    _v = VFN(VFFSL(SL,"hardware",True),"properties",True)["arch"] # u'$hardware.properties["arch"]' on line 18, col 10
