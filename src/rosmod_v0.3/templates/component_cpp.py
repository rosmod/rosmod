...
__CHEETAH_genTime__ = 1441657172.174338
...
__CHEETAH_srcLastModified__ = 'Thu Sep  3 08:02:22 2015'
...
''')
                    for sub in VFFSL(SL,"subscribers",True): # generated from line 54, col 1
                        write(u'''  if (config.profileMap.find("''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"$sub.properties['name']" on line 55, col 31
                        if _v is not None: write(_filter(_v, rawExpr=u"$sub.properties['name']")) # from line 55, col 31.
                        write(u'''") != config.profileMap.end())
    {
      ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 57, col 7
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 57, col 7.
                        write(u'''_recv_mw.init(node_argc,
\t\t\t\t\t     node_argv,
\t\t\t\t\t     config.profileMap["''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"$sub.properties['name']" on line 59, col 30
                        if _v is not None: write(_filter(_v, rawExpr=u"$sub.properties['name']")) # from line 59, col 30.
                        write(u'''"],
\t\t\t\t\t     capacityBits);
      if ( tg_duration < 0 )
\t''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 62, col 2
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 62, col 2.
                        write(u'''_recv_mw.set_duration(''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 62, col 49
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 62, col 49.
                        write(u'''_recv_mw.profile.period);
      else
\t''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 64, col 2
      ...
      fName = nodeName + "." + compName + ".''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 65, col 45
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 65, col 45.
                        write(u'''.network.csv";
      ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 66, col 7
      ...
      ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 67, col 7
      ...
      ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 68, col 7
                        ...
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 68, col 77
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 68, col 77.
                        write(u'''::mw_recv_done_callback, this, &''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 68, col 124
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 68, col 124.
                        write(u'''_recv_mw));
      ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 69, col 7
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 69, col 7.
                        write(u'''_id = 0;
    }
  if (config.portSenderMap.find("''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"$sub.properties['name']" on line 71, col 34
                        ...
                        write(u'''") != config.portSenderMap.end())
    {
      for (auto it=config.portSenderMap["''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"$sub.properties['name']" on line 73, col 42
                        if _v is not None: write(_filter(_v, rawExpr=u"$sub.properties['name']")) # from line 73, col 42.
                        write(u'''"].begin();
\t   it != config.portSenderMap["''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"$sub.properties['name']" on line 74, col 33
                        if _v is not None: write(_filter(_v, rawExpr=u"$sub.properties['name']")) # from line 74, col 33.
                        write(u'''"].end(); ++it)
\t{
\t  ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 76, col 4
...
''')
                if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 82, col 1
...
''')
                    for pub in VFFSL(SL,"publishers",True): # generated from line 102, col 1
                        write(u'''  if (config.profileMap.find("''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"$pub.properties['name']" on line 103, col 31
                        if _v is not None: write(_filter(_v, rawExpr=u"$pub.properties['name']")) # from line 103, col 31.
                        write(u'''") != config.profileMap.end())
    {
      ''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 105, col 7
                        if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 105, col 7.
                        write(u'''_send_mw.init(node_argc,
\t\t\t\t\t     node_argv,
\t\t\t\t\t     config.uuidMap["''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"$pub.properties['name']" on line 107, col 27
                        if _v is not None: write(_filter(_v, rawExpr=u"$pub.properties['name']")) # from line 107, col 27.
                        write(u'''"],
\t\t\t\t\t     config.profileMap["''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"$pub.properties['name']" on line 108, col 30
                        if _v is not None: write(_filter(_v, rawExpr=u"$pub.properties['name']")) # from line 108, col 30.
                        write(u'''"]);
      if ( tg_duration < 0 )
\t''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 110, col 2
                        if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 110, col 2.
                        write(u'''_send_mw.set_duration(''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 110, col 49
                        if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 110, col 49.
                        write(u'''_send_mw.profile.period);
      else
\t''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 112, col 2
      ...
      fName = nodeName + "." + compName + ".''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 113, col 45
                        if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 113, col 45.
                        write(u'''.network.csv";
      ''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 114, col 7
...
\t(ros::Duration(-1),
\t boost::bind(&''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 119, col 16
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 119, col 16.
                        write(u'''::''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 119, col 33
                        if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 119, col 33.
                        write(u'''_timerCallback, this, _1),
\t &this->compQueue,
\t true);
      ''')
                        _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 122, col 7
...
''')
            if VFFSL(SL,"mod",True) != "": # generated from line 129, col 1
                write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Exiting ''')
                _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 130, col 42
...
''')
            ...
            write(u'''//# Start Init Marker
''')
            _v = VFFSL(SL,"init_business_logic",True) # u'$init_business_logic' on line 136, col 1
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 140, col 1
            for pub in VFFSL(SL,"publishers",True): # generated from line 141, col 1
                write(u'''void ''')
                _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 142, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 142, col 6.
                write(u'''::''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 142, col 23
...
{
  ''')
                _v = VFN(VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$pub.properties["message_reference"].parent.properties["name"]' on line 144, col 3
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["message_reference"].parent.properties["name"]')) # from line 144, col 3.
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${pub.properties["message_reference"].properties["name"]}' on line 144, col 67
                if _v is not None: write(_filter(_v, rawExpr=u'${pub.properties["message_reference"].properties["name"]}')) # from line 144, col 67.
                write(u''' msg;
  msg.uuid = ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 145, col 14
  ...
  try
    {
      timerDelay =
\t''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 151, col 2
                if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 151, col 2.
                write(u'''_send_mw.send<''')
                _v = VFN(VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$pub.properties["message_reference"].parent.properties["name"]' on line 151, col 41
                ...
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${pub.properties["message_reference"].properties["name"]}' on line 151, col 105
                if _v is not None: write(_filter(_v, rawExpr=u'${pub.properties["message_reference"].properties["name"]}')) # from line 151, col 105.
                write(u'''>(''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"$pub.properties['name']" on line 151, col 164
  ...
  if ( ros::Time::now() >= ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 158, col 28
                if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 158, col 28.
                write(u'''_send_mw.get_end_time() )
    {
      LOGGER.DEBUG("writing output\\n");
      ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 161, col 7
...
\t boost::bind(&''')
                _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 171, col 16
                if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 171, col 16.
                write(u'''::''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 171, col 33
...
\t true);
      ros::NodeHandle nh;
      ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 175, col 7
...
''')
        write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 181, col 1
            if VFFSL(SL,"trafficGen",True): # generated from line 182, col 1
                write(u'''void ''')
                _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 183, col 6
...
''')
            write(u'''
''')
            for sub in VFFSL(SL,"subscribers",True): # generated from line 191, col 1
                write(u'''// Subscriber Callback - ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 192, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 192, col 26.
                write(u'''
''')
                if VFN(VFFSL(SL,"sub",True),"properties",True)["business_logic"] == "": # generated from line 193, col 1
                    write(u'''//# Start ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 194, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 194, col 11.
                    write(u'''_OnOneData Marker
void ''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 195, col 6
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 195, col 6.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 195, col 23
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 195, col 23.
                    write(u'''_OnOneData(const ''')
                    _v = VFN(VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$sub.properties["message_reference"].parent.properties["name"]' on line 195, col 65
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 195, col 129
...
{
''')
                    if VFFSL(SL,"mod",True) != "": # generated from line 197, col 1
                        write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Entering ''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 198, col 43
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 198, col 43.
                        write(u'''::''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 198, col 60
                        if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 198, col 60.
                        write(u'''_OnOneData");
''')
                    write(u'''  // Business Logic for ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 200, col 25
                    if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 200, col 25.
                    write(u''' Subscriber

''')
                    if VFFSL(SL,"trafficGen",True): # generated from line 202, col 1
                        write(u'''  uint64_t uuid = received_data->uuid;
  uint64_t msgBytes = ros::serialization::Serializer<''')
                        _v = VFN(VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$sub.properties["message_reference"].parent.properties["name"]' on line 204, col 54
                        ...
                        write(u'''::''')
                        _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 204, col 118
  ...
  ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 206, col 3
  ...
  new_msg.Id(''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 209, col 14
                        if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 209, col 14.
                        write(u'''_id++);
  new_msg.TimeStamp();
  ''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 211, col 3
...
''')
                    write(u'''  
''')
                    if VFFSL(SL,"mod",True) != "": # generated from line 214, col 1
                        write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Exiting ''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 215, col 42
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 215, col 42.
                        write(u'''::''')
                        _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 215, col 59
                        if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 215, col 59.
                        write(u'''_OnOneData");
''')
                    write(u'''}
//# End ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 218, col 9
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 218, col 9.
                    write(u'''_OnOneData Marker
''')
                else: # generated from line 219, col 1
                    write(u'''//# Start ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 220, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 220, col 11.
                    write(u'''_OnOneData Marker
''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["business_logic"] # u'$sub.properties["business_logic"]' on line 221, col 1
                    if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["business_logic"]')) # from line 221, col 1.
                    write(u'''//# End ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 221, col 42
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 221, col 42.
                    write(u'''_OnOneData Marker
''')
            write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"provided_services",True)) > 0: # generated from line 226, col 1
            for server in VFFSL(SL,"servers",True): # generated from line 227, col 1
                write(u'''// Server Callback - ''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'$server.properties["name"]' on line 228, col 22
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["name"]')) # from line 228, col 22.
                write(u'''
''')
                if VFN(VFFSL(SL,"server",True),"properties",True)["business_logic"] == "": # generated from line 229, col 1
                    write(u'''//# Start ''')
...
bool ''')
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 231, col 23
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 231, col 23.
                    write(u'''Callback(''')
                    _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 231, col 92
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 231, col 159
                    if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["service_reference"].properties["name"]')) # from line 231, col 159.
                    write(u'''::Request  &req,
  ''')
                    _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 232, col 3
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 232, col 70
...
{
''')
                    if VFFSL(SL,"mod",True) != "": # generated from line 234, col 1
                        write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Entering ''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 235, col 43
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 235, col 43.
                        write(u'''::''')
                        _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 235, col 60
                        if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 235, col 60.
                        write(u'''Callback");
''')
                    write(u'''  // Business Logic for ''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'$server.properties["name"]' on line 237, col 25
                    if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["name"]')) # from line 237, col 25.
                    write(u''' Server

''')
                    if VFFSL(SL,"mod",True) != "": # generated from line 239, col 1
                        write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Exiting ''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 240, col 42
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 240, col 42.
                        write(u'''::''')
                        _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 240, col 59
...
//# End ''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 244, col 9
...
''')
                    ...
                    write(u'''//# Start ''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 246, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 246, col 11.
                    write(u'''Callback Marker
''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["business_logic"] # u'$server.properties["business_logic"]' on line 247, col 1
                    if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["business_logic"]')) # from line 247, col 1.
                    write(u'''//# End ''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 247, col 45
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 247, col 45.
                    write(u'''Callback Marker
''')
            write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)) > 0: # generated from line 252, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 253, col 1
                write(u'''// Timer Callback - ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 254, col 21
                if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 254, col 21.
                write(u'''
''')
                if VFN(VFFSL(SL,"timer",True),"properties",True)["business_logic"] == "": # generated from line 255, col 1
                    write(u'''//# Start ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 256, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 256, col 11.
                    write(u'''Callback Marker
void ''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 257, col 6
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 257, col 6.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 257, col 23
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 257, col 23.
                    write(u'''Callback(const ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 257, col 68
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 257, col 68.
                    write(u'''::TimerEvent& event)
{
''')
                    if VFFSL(SL,"mod",True) != "": # generated from line 259, col 1
                        write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Entering ''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 260, col 43
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 260, col 43.
                        write(u'''::''')
                        _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 260, col 60
                        if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 260, col 60.
                        write(u'''Callback");
''')
                    write(u'''  // Business Logic for ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 262, col 25
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 262, col 25.
                    write(u''' Timer

''')
                    if VFFSL(SL,"mod",True) != "": # generated from line 264, col 1
                        write(u'''  compQueue.ROSMOD_LOGGER.DEBUG("Exiting ''')
                        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 265, col 42
                        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 265, col 42.
                        write(u'''::''')
                        _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 265, col 59
                        if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 265, col 59.
                        write(u'''Callback");
''')
                    write(u'''}
//# End ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 268, col 9
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 268, col 9.
                    write(u'''Callback Marker
''')
                else: # generated from line 269, col 1
                    write(u'''//# Start ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 270, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 270, col 11.
                    write(u'''Callback Marker
''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["business_logic"] # u'$timer.properties["business_logic"]' on line 271, col 1
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["business_logic"]')) # from line 271, col 1.
                    write(u'''//# End ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 271, col 44
...
''')
        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 278, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 278, col 1.
        write(u'''::~''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 278, col 19
        if _v is not None: write(_filter(_v, rawExpr=u'${component_name}')) # from line 278, col 19.
        write(u'''()
{
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)) > 0: # generated from line 280, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 281, col 1
                write(u'''  ''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 282, col 3
                if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 282, col 3.
                write(u'''.stop();
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 285, col 1
            for pub in VFFSL(SL,"publishers",True): # generated from line 286, col 1
                write(u'''  ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'${pub.properties["name"]}' on line 287, col 3
                if _v is not None: write(_filter(_v, rawExpr=u'${pub.properties["name"]}')) # from line 287, col 3.
                write(u'''.shutdown();
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 290, col 1
            for sub in VFFSL(SL,"subscribers",True): # generated from line 291, col 1
                write(u'''  ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 292, col 3
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 292, col 3.
                write(u'''.shutdown();
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"provided_services",True)) > 0: # generated from line 295, col 1
            for server in VFFSL(SL,"servers",True): # generated from line 296, col 1
                write(u'''  ''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 297, col 3
                if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 297, col 3.
                write(u'''.shutdown();
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"required_services",True)) > 0: # generated from line 300, col 1
            for client in VFFSL(SL,"clients",True): # generated from line 301, col 1
                write(u'''  ''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'${client.properties["name"]}' on line 302, col 3
                if _v is not None: write(_filter(_v, rawExpr=u'${client.properties["name"]}')) # from line 302, col 3.
                write(u'''.shutdown();
''')
        if VFFSL(SL,"destructor",True) == "": # generated from line 305, col 1
...
''')
            ...
            write(u'''  //# Start Destructor Marker
''')
            _v = VFFSL(SL,"destructor",True) # u'$destructor' on line 310, col 1
...
void ''')
        _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 315, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 315, col 6.
        write(u'''::startUp()
{
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 317, col 6
...
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 321, col 1
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"subscribers",True)) > 0: # generated from line 326, col 1
            for sub in VFFSL(SL,"subscribers",True): # generated from line 327, col 1
                if VFFSL(SL,"mod",True) != "": # generated from line 328, col 1
                    write(u'''  callback_options.alias = "''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 329, col 29
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 329, col 29.
                    write(u'''_OnOneData";
  callback_options.priority = ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["priority"] # u'$sub.properties["priority"]' on line 330, col 31
                    if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["priority"]')) # from line 330, col 31.
                    write(u''';
  callback_options.deadline.sec = ''')
                    _v = VFFSL(SL,"int",False)(sub.properties["deadline"].split('.')[0]) # u'${int(sub.properties["deadline"].split(\'.\')[0])}' on line 331, col 35
  ...
  callback_options.deadline.nsec = ''')
                    _v = VFFSL(SL,"int",False)(float('0.' + (sub.properties["deadline"].split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (sub.properties["deadline"].split(\'.\')[1]))*1000000000)}' on line 332, col 36
...
''')
                ...
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 334, col 29
                if _v is not None: write(_filter(_v, rawExpr=u'$sub.properties["name"]')) # from line 334, col 29.
                write(u'''
  advertiseName = "''')
                _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 335, col 20
  ...
  if (portGroupMap.find("''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 336, col 26
    ...
    advertiseName += "_" + portGroupMap["''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 337, col 42
                if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 337, col 42.
                write(u'''"];
  ros''')
                _v = VFFSL(SL,"mod",True) # u'${mod}' on line 338, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 338, col 6.
                write(u'''::SubscribeOptions ''')
                _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 338, col 31
                if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 338, col 31.
                write(u'''_options;
''')
                if VFFSL(SL,"mod",True) != "": # generated from line 339, col 1
                    write(u'''  ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 340, col 3
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 340, col 3.
                    write(u'''_options = ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 340, col 42
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 340, col 42.
                    write(u'''::SubscribeOptions::create<''')
                    _v = VFN(VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$sub.properties["message_reference"].parent.properties["name"]' on line 340, col 75
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 340, col 139
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["message_reference"].properties["name"]}')) # from line 340, col 139.
                    write(u'''>
      (advertiseName.c_str(),
       1000,
       boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 343, col 21
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 343, col 21.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 343, col 38
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 343, col 38.
                    write(u'''_OnOneData, this, _1),
       ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 344, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 344, col 11.
                    write(u'''::VoidPtr(),
       &this->compQueue,
       callback_options);
  this->''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 347, col 9
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 347, col 9.
                    write(u''' = nh.subscribe(''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 347, col 50
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 347, col 50.
                    write(u'''_options);
''')
                else: # generated from line 348, col 1
                    write(u'''  ''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 349, col 3
                    ...
                    _v = VFN(VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$sub.properties["message_reference"].parent.properties["name"]' on line 349, col 69
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 349, col 133
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["message_reference"].properties["name"]}')) # from line 349, col 133.
                    write(u'''>
      (advertiseName.c_str(),
       1000,
       boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 352, col 21
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 352, col 21.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 352, col 38
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 352, col 38.
                    write(u'''_OnOneData, this, _1),
       ros::VoidPtr(),
       &this->compQueue);
  this->''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 355, col 9
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 355, col 9.
                    write(u''' = nh.subscribe(''')
                    _v = VFN(VFFSL(SL,"sub",True),"properties",True)["name"] # u'${sub.properties["name"]}' on line 355, col 50
                    if _v is not None: write(_filter(_v, rawExpr=u'${sub.properties["name"]}')) # from line 355, col 50.
                    write(u'''_options);  
''')
            write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"publishers",True)) > 0: # generated from line 360, col 1
            for pub in VFFSL(SL,"publishers",True): # generated from line 361, col 1
                write(u'''  // Component Publisher - ''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 362, col 28
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 362, col 28.
                write(u'''
  advertiseName = "''')
                _v = VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${pub.properties["message_reference"].properties["name"]}' on line 363, col 20
                if _v is not None: write(_filter(_v, rawExpr=u'${pub.properties["message_reference"].properties["name"]}')) # from line 363, col 20.
                write(u'''";
  if (portGroupMap.find("''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 364, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 364, col 26.
                write(u'''") != portGroupMap.end())
    advertiseName += "_" + portGroupMap["''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 365, col 42
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 365, col 42.
                write(u'''"];
  this->''')
                _v = VFN(VFFSL(SL,"pub",True),"properties",True)["name"] # u'${pub.properties["name"]}' on line 366, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'${pub.properties["name"]}')) # from line 366, col 9.
                write(u''' = nh.advertise<''')
                _v = VFN(VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$pub.properties["message_reference"].parent.properties["name"]' on line 366, col 50
                ...
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"pub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${pub.properties["message_reference"].properties["name"]}' on line 366, col 114
...
''')
            write(u'''
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"provided_services",True)): # generated from line 370, col 1
            for server in VFFSL(SL,"servers",True): # generated from line 371, col 1
                if VFFSL(SL,"mod",True) != "": # generated from line 372, col 1
                    write(u'''  callback_options.alias = "''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 373, col 29
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 373, col 29.
                    write(u'''Callback";
  callback_options.priority = ''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["priority"] # u'$server.properties["priority"]' on line 374, col 31
                    if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["priority"]')) # from line 374, col 31.
                    write(u''';
  callback_options.deadline.sec =''')
                    _v = VFFSL(SL,"int",False)(server.properties["deadline"].split('.')[0]) # u'${int(server.properties["deadline"].split(\'.\')[0])}' on line 375, col 34
                    if _v is not None: write(_filter(_v, rawExpr=u'${int(server.properties["deadline"].split(\'.\')[0])}')) # from line 375, col 34.
                    write(u''';
  callback_options.deadline.nsec = ''')
                    _v = VFFSL(SL,"int",False)(float('0.' + (server.properties["deadline"].split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (server.properties["deadline"].split(\'.\')[1]))*1000000000)}' on line 376, col 36
...
''')
                ...
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'$server.properties["name"]' on line 378, col 25
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["name"]')) # from line 378, col 25.
                write(u'''
  advertiseName = "''')
                _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 379, col 20
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["service_reference"].properties["name"]')) # from line 379, col 20.
                write(u'''";
  if (portGroupMap.find("''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'$server.properties["name"]' on line 380, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["name"]')) # from line 380, col 26.
                write(u'''") != portGroupMap.end())
    advertiseName += "_" + portGroupMap["''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'$server.properties["name"]' on line 381, col 42
                if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["name"]')) # from line 381, col 42.
                write(u'''"];
  ros''')
                _v = VFFSL(SL,"mod",True) # u'${mod}' on line 382, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 382, col 6.
                write(u'''::AdvertiseServiceOptions ''')
                _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 382, col 38
                if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 382, col 38.
                write(u'''_server_options;
''')
                if VFFSL(SL,"mod",True) != "": # generated from line 383, col 1
                    write(u'''  ''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 384, col 3
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 384, col 3.
                    write(u'''_server_options = ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 384, col 52
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 384, col 52.
                    write(u'''::AdvertiseServiceOptions::create<''')
                    _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 384, col 92
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 384, col 159
                    if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["service_reference"].properties["name"]')) # from line 384, col 159.
                    write(u'''>
      (advertiseName.c_str(),
       boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 386, col 21
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 386, col 21.
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 386, col 38
       ...
       ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 387, col 11
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 387, col 11.
                    write(u'''::VoidPtr(),
       &this->compQueue,
       callback_options);
  this->''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 390, col 9
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 390, col 9.
                    write(u''' = nh.advertiseService(''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 390, col 60
...
''')
                    ...
                    write(u'''  ''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 392, col 3
                    ...
                    _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 392, col 86
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 392, col 153
                    if _v is not None: write(_filter(_v, rawExpr=u'$server.properties["service_reference"].properties["name"]')) # from line 392, col 153.
                    write(u'''>
      (advertiseName.c_str(),
       boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 394, col 21
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 394, col 21.
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'${server.properties["service_reference"].properties["name"]}' on line 394, col 38
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["service_reference"].properties["name"]}')) # from line 394, col 38.
                    write(u'''Callback, this, _1, _2),
       ros::VoidPtr(),
       &this->compQueue);
  this->''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 397, col 9
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 397, col 9.
                    write(u''' = nh.advertiseService(''')
                    _v = VFN(VFFSL(SL,"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 397, col 60
                    if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 397, col 60.
                    write(u'''_server_options);  
''')
            write(u''' 
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"required_services",True)) > 0: # generated from line 402, col 1
            write(u'''  // Configure all required services associated with this component
''')
            for client in VFFSL(SL,"clients",True): # generated from line 404, col 1
                write(u'''  // Component Client - ''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 405, col 25
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 405, col 25.
                write(u'''
  advertiseName = "''')
                _v = VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$client.properties["service_reference"].properties["name"]' on line 406, col 20
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["service_reference"].properties["name"]')) # from line 406, col 20.
                write(u'''";
  if (portGroupMap.find("''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 407, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 407, col 26.
                write(u'''") != portGroupMap.end())
    advertiseName += "_" + portGroupMap["''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 408, col 42
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 408, col 42.
                write(u'''"];
  this->''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'${client.properties["name"]}' on line 409, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'${client.properties["name"]}')) # from line 409, col 9.
                write(u''' = nh.serviceClient<''')
                _v = VFN(VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$client.properties["service_reference"].parent.properties["name"]' on line 409, col 57
                ...
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$client.properties["service_reference"].properties["name"]' on line 409, col 124
...
''')
            ...
            write(u'''  ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 429, col 6
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 429, col 6.
            write(u'''::TimerOptions timer_options;
  timer_options = 
    ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 431, col 8
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 431, col 8.
            write(u'''::TimerOptions
    (ros::Duration(-1),
     boost::bind(&''')
            _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 433, col 19
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 440, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 441, col 1
                if VFFSL(SL,"mod",True) != "": # generated from line 442, col 1
                    write(u'''  callback_options.alias = "''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 443, col 29
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 443, col 29.
                    write(u'''Callback";
  callback_options.priority = ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["priority"] # u'$timer.properties["priority"]' on line 444, col 31
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["priority"]')) # from line 444, col 31.
                    write(u''';
  callback_options.deadline.sec = ''')
                    _v = VFFSL(SL,"int",False)(timer.properties["deadline"].split('.')[0]) # u'${int(timer.properties["deadline"].split(\'.\')[0])}' on line 445, col 35
                    if _v is not None: write(_filter(_v, rawExpr=u'${int(timer.properties["deadline"].split(\'.\')[0])}')) # from line 445, col 35.
                    write(u''';
  callback_options.deadline.nsec = ''')
                    _v = VFFSL(SL,"int",False)(float('0.' + (timer.properties["deadline"].split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (timer.properties["deadline"].split(\'.\')[1]))*1000000000)}' on line 446, col 36
                    ...
                    write(u''';
  // Component Timer - ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 447, col 24
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 447, col 24.
                    write(u'''
  timer_options = 
    ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 449, col 8
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 449, col 8.
                    write(u'''::TimerOptions
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 450, col 1
                        write(u'''    (ros::Duration(-1),
''')
                    else: # generated from line 452, col 1
                        write(u'''    (ros::Duration(''')
                        _v = VFN(VFFSL(SL,"timer",True),"properties",True)["period"] # u'$timer.properties["period"]' on line 453, col 20
                        if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["period"]')) # from line 453, col 20.
                        write(u'''),
''')
                    write(u'''     boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 455, col 19
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 455, col 19.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 455, col 36
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 455, col 36.
                    write(u'''Callback, this, _1),
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 456, col 1
...
''')
                    ...
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 468, col 24
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 468, col 24.
                    write(u'''
  timer_options = 
    ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 470, col 8
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 470, col 8.
                    write(u'''::TimerOptions
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 471, col 1
                        write(u'''    (ros::Duration(-1),
''')
                    else: # generated from line 473, col 1
                        write(u'''    (ros::Duration(''')
                        _v = VFN(VFFSL(SL,"timer",True),"properties",True)["period"] # u'$timer.properties["period"]' on line 474, col 20
                        if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["period"]')) # from line 474, col 20.
                        write(u'''),
''')
                    write(u'''     boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 476, col 19
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 476, col 19.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 476, col 36
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 476, col 36.
                    write(u'''Callback, this, _1),
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 477, col 1
...
''')
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 483, col 9
...
''')
        if VFFSL(SL,"component_type",True) == "KSP": # generated from line 507, col 1
...
''')
  ...
  comp_sync_sub_options = ros''')
    ...
    ("component_synchronization",
     ...
     ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 520, col 9
...
''')
            ...
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 524, col 30
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 524, col 30.
            write(u'''::SubscribeOptions::create<std_msgs::Bool>
    ("component_synchronization",
     1000,
     boost::bind(&''')
            _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 527, col 19
            if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 527, col 19.
            write(u'''::component_synchronization_OnOneData, this, _1),
     ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 528, col 9
...
''')
  ...
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 533, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 533, col 6.
        write(u'''::Time now = ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 533, col 28
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 542, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 543, col 1
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 544, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'$(timer.properties["name"])')) # from line 544, col 9.
                write(u'''.start();
''')
        write(u'''  
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 548, col 1
...
extern "C" {
  Component *maker(ComponentConfig &config, int argc, char **argv) {
    return new ''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 555, col 16
