...
__CHEETAH_genTime__ = 1438794319.100963
__CHEETAH_genTimestamp__ = 'Wed Aug  5 12:05:19 2015'
__CHEETAH_src__ = '/home/jeb/Repositores/rosmod-gui/src/rosmod_v0.3/templates/component_cpp.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Aug  5 11:05:28 2015'
...
void ''')
                    ...
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 92, col 68
...
''')
            ...
            write(u'''  //# Start Destructor Marker
''')
            _v = VFFSL(SL,"destructor",True) # u'$destructor' on line 145, col 1
...
''')
  ...
  callback_options.deadline.nsec = ''')
                    _v = VFFSL(SL,"int",False)(float('0.' + (sub.properties["deadline"].split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (sub.properties["deadline"].split(\'.\')[1]))*1000000000)}' on line 167, col 36
...
''')
                    ...
                    _v = VFN(VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"parent",True),"properties",True)["name"] # u'$sub.properties["message_reference"].parent.properties["name"]' on line 184, col 69
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"sub",True),"properties",True)["message_reference"],"properties",True)["name"] # u'${sub.properties["message_reference"].properties["name"]}' on line 184, col 133
...
''')
  ...
  callback_options.deadline.sec =''')
                    ...
                    write(u''';
  callback_options.deadline.nsec = ''')
                    _v = VFFSL(SL,"int",False)(float('0.' + (server.properties["deadline"].split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (server.properties["deadline"].split(\'.\')[1]))*1000000000)}' on line 211, col 36
...
''')
                    ...
                    _v = VFN(VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$server.properties["service_reference"].parent.properties["name"]' on line 227, col 86
                    ...
                    write(u'''::''')
                    _v = VFN(VFN(VFFSL(SL,"server",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$server.properties["service_reference"].properties["name"]' on line 227, col 153
...
''')
  ...
  if (portGroupMap.find("''')
    ...
    advertiseName += "_" + portGroupMap["''')
                ...
                write(u'''"];
  this->''')
                _v = VFN(VFFSL(SL,"client",True),"properties",True)["name"] # u'${client.properties["name"]}' on line 244, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'${client.properties["name"]}')) # from line 244, col 9.
                write(u''' = nh.serviceClient<''')
                _v = VFN(VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"parent",True),"properties",True)["name"] # u'$client.properties["service_reference"].parent.properties["name"]' on line 244, col 57
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["service_reference"].parent.properties["name"]')) # from line 244, col 57.
                write(u'''::''')
                _v = VFN(VFN(VFFSL(SL,"client",True),"properties",True)["service_reference"],"properties",True)["name"] # u'$client.properties["service_reference"].properties["name"]' on line 244, col 124
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["service_reference"].properties["name"]')) # from line 244, col 124.
...
''')
            ...
            write(u'''  ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 264, col 6
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 264, col 6.
            write(u'''::TimerOptions timer_options;
  timer_options = 
    ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 266, col 8
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 266, col 8.
            write(u'''::TimerOptions
    (ros::Duration(-1),
     boost::bind(&''')
            _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 268, col 19
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 275, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 276, col 1
                if VFFSL(SL,"mod",True) != "": # generated from line 277, col 1
                    write(u'''  callback_options.alias = "''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 278, col 29
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 278, col 29.
                    write(u'''Callback";
  callback_options.priority = ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["priority"] # u'$timer.properties["priority"]' on line 279, col 31
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["priority"]')) # from line 279, col 31.
                    write(u''';
  callback_options.deadline.sec = ''')
                    _v = VFFSL(SL,"int",False)(timer.properties["deadline"].split('.')[0]) # u'${int(timer.properties["deadline"].split(\'.\')[0])}' on line 280, col 35
                    if _v is not None: write(_filter(_v, rawExpr=u'${int(timer.properties["deadline"].split(\'.\')[0])}')) # from line 280, col 35.
                    write(u''';
  callback_options.deadline.nsec = ''')
                    _v = VFFSL(SL,"int",False)(float('0.' + (timer.properties["deadline"].split('.')[1]))*1000000000) # u'${int(float(\'0.\' + (timer.properties["deadline"].split(\'.\')[1]))*1000000000)}' on line 281, col 36
                    ...
                    write(u''';
  // Component Timer - ''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 282, col 24
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 282, col 24.
                    write(u'''
  timer_options = 
    ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 284, col 8
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 284, col 8.
                    write(u'''::TimerOptions
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 285, col 1
                        write(u'''    (ros::Duration(-1),
''')
                    else: # generated from line 287, col 1
                        write(u'''    (ros::Duration(''')
                        _v = VFN(VFFSL(SL,"timer",True),"properties",True)["period"] # u'$timer.properties["period"]' on line 288, col 20
                        if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["period"]')) # from line 288, col 20.
                        write(u'''),
''')
                    write(u'''     boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 290, col 19
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 290, col 19.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 290, col 36
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 290, col 36.
                    write(u'''Callback, this, _1),
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 291, col 1
...
''')
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 318, col 9
...
''')
  ...
  comp_sync_sub_options = ros''')
    ...
    ("component_synchronization",
     ...
     ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 355, col 9
...
''')
            ...
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 359, col 30
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 359, col 30.
            write(u'''::SubscribeOptions::create<std_msgs::Bool>
    ("component_synchronization",
     1000,
     boost::bind(&''')
            _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 362, col 19
            if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 362, col 19.
            write(u'''::component_synchronization_OnOneData, this, _1),
     ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 363, col 9
...
''')
  ...
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 368, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 368, col 6.
        write(u'''::Time now = ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 368, col 28
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 377, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 378, col 1
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 379, col 9
...
extern "C" {
  Component *maker(ComponentConfig &config, int argc, char **argv) {
    return new ''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 390, col 16
