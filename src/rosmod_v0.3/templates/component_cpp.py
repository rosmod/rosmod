...
__CHEETAH_genTime__ = 1437062552.032327
...
__CHEETAH_srcLastModified__ = 'Thu Jul 16 11:02:13 2015'
...
''')
                    ...
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$timer.properties["name"]' on line 302, col 24
                    if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["name"]')) # from line 302, col 24.
                    write(u'''
  timer_options = 
    ros''')
                    _v = VFFSL(SL,"mod",True) # u'${mod}' on line 304, col 8
                    if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 304, col 8.
                    write(u'''::TimerOptions
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 305, col 1
                        write(u'''    (ros::Duration(-1),
''')
                    else: # generated from line 307, col 1
                        write(u'''    (ros::Duration(''')
                        _v = VFN(VFFSL(SL,"timer",True),"properties",True)["period"] # u'$timer.properties["period"]' on line 308, col 20
                        if _v is not None: write(_filter(_v, rawExpr=u'$timer.properties["period"]')) # from line 308, col 20.
                        write(u'''),
''')
                    write(u'''     boost::bind(&''')
                    _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 310, col 19
                    if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 310, col 19.
                    write(u'''::''')
                    _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'${timer.properties["name"]}' on line 310, col 36
                    if _v is not None: write(_filter(_v, rawExpr=u'${timer.properties["name"]}')) # from line 310, col 36.
                    write(u'''Callback, this, _1),
''')
                    if VFN(VFFSL(SL,"timer",True),"properties",True)["period"] == "0.0": # generated from line 311, col 1
...
''')
        if VFFSL(SL,"component_type",True) == "KSP": # generated from line 341, col 1
...
''')
  ...
  comp_sync_sub_options = ros''')
    ...
    ("component_synchronization",
     ...
     ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 354, col 9
...
''')
            ...
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 358, col 30
            if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 358, col 30.
            write(u'''::SubscribeOptions::create<std_msgs::Bool>
    ("component_synchronization",
     1000,
     boost::bind(&''')
            _v = VFFSL(SL,"component_name",True) # u'$component_name' on line 361, col 19
            if _v is not None: write(_filter(_v, rawExpr=u'$component_name')) # from line 361, col 19.
            write(u'''::component_synchronization_OnOneData, this, _1),
     ros''')
            _v = VFFSL(SL,"mod",True) # u'${mod}' on line 362, col 9
...
''')
  ...
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 367, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 367, col 6.
        write(u'''::Time now = ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 367, col 28
...
''')
        if VFFSL(SL,"len",False)(VFFSL(SL,"timers",True)): # generated from line 374, col 1
            for timer in VFFSL(SL,"timers",True): # generated from line 375, col 1
                write(u'''  this->''')
                _v = VFN(VFFSL(SL,"timer",True),"properties",True)["name"] # u'$(timer.properties["name"])' on line 376, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'$(timer.properties["name"])')) # from line 376, col 9.
                write(u'''.start();
''')
        write(u'''  
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 380, col 1
...
extern "C" {
  Component *maker(ComponentConfig &config, int argc, char **argv) {
    return new ''')
        _v = VFFSL(SL,"component_name",True) # u'${component_name}' on line 387, col 16
