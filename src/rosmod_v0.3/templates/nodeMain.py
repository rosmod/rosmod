...
__CHEETAH_genTime__ = 1440176560.942724
...
__CHEETAH_srcLastModified__ = 'Fri Aug 21 09:03:27 2015'
...
class nodeMain(Template):
    ...
    def respond(self, trans=None):
        ...
        if VFFSL(SL,"mod",True) != "": # generated from line 1, col 1
...
\tROS_INFO_STREAM("Opened " << nodeParser.libList[i]);
    ...
    ros''')
        _v = VFFSL(SL,"mod",True) # u'$mod' on line 71, col 8
        if _v is not None: write(_filter(_v, rawExpr=u'$mod')) # from line 71, col 8.
        write(u'''::init(argc, argv, nodeName.c_str());

    // Create Node Handle
    ros''')
        _v = VFFSL(SL,"mod",True) # u'$mod' on line 74, col 8
        if _v is not None: write(_filter(_v, rawExpr=u'$mod')) # from line 74, col 8.
