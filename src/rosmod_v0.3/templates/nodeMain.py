...
__CHEETAH_genTime__ = 1441394247.180166
...
__CHEETAH_srcLastModified__ = 'Tue Aug 25 19:17:02 2015'
...
\tROS_INFO_STREAM("Opened " << nodeParser.libList[i]);
    ...
    ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'$mod' on line 72, col 8
        if _v is not None: write(_filter(_v, rawExpr=u'$mod')) # from line 72, col 8.
        write(u'''::init(argc, argv, nodeName.c_str());

    // Create Node Handle
    ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'$mod' on line 75, col 8
