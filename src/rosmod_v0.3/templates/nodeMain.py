...
__CHEETAH_genTime__ = 1440191288.758634
...
\tROS_INFO_STREAM("Opened " << nodeParser.libList[i]);
    ...
    ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'$mod' on line 71, col 8
        if _v is not None: write(_filter(_v, rawExpr=u'$mod')) # from line 71, col 8.
        write(u'''::init(argc, argv, nodeName.c_str());

    // Create Node Handle
    ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'$mod' on line 74, col 8
