...
__CHEETAH_genTime__ = 1436979669.069183
...
''')
        ...
        write(u''' <string>
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 6, col 1
...
''')
        ...
        write(u''' "''')
        _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 13, col 16
        if _v is not None: write(_filter(_v, rawExpr=u'$package_name')) # from line 13, col 16.
...
public:
  ...
  virtual void Init(const ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 25, col 30
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 25, col 30.
...
protected:
  ...
  char **node_argv;
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 41, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 41, col 6.
        write(u'''::Timer initOneShotTimer; 
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 42, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 42, col 6.
