...
__CHEETAH_genTime__ = 1437062551.958229
...
__CHEETAH_srcLastModified__ = 'Thu Jul 16 10:47:56 2015'
...
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 7, col 1
...
''')
        ...
        write(u''' "''')
        _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 14, col 16
...
''')
        ...
        write(u''' "''')
        _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 15, col 16
...
public:
  ...
  virtual void Init(const ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 26, col 30
...
protected:
  ...
  std::string compName;
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 43, col 1
            write(u'''  rosmod::CallbackQueue::SchedulingScheme scheduling_scheme;
''')
        write(u'''  int node_argc;
  char **node_argv;
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 48, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 48, col 6.
        write(u'''::Publisher comp_sync_pub;
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 49, col 6
  ...
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 52, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 52, col 6.
        write(u'''::Timer initOneShotTimer; 
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 53, col 6
