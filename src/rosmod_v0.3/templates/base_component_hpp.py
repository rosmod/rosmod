...
__CHEETAH_genTime__ = 1437012722.968914
...
__CHEETAH_srcLastModified__ = 'Wed Jul 15 21:10:06 2015'
...
protected:
  ...
  char **node_argv;
  ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 45, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 45, col 6.
        write(u'''::Publisher comp_sync_pub;
  ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 46, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 46, col 6.
