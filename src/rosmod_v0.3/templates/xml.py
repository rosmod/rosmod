...
__CHEETAH_genTime__ = 1440191289.02753
__CHEETAH_genTimestamp__ = 'Fri Aug 21 16:08:09 2015'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod-gui/src/rosmod_v0.3/templates/xml.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Aug 21 15:47:37 2015'
...
''')
                for port in VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"comp_instance",True),"properties",True)['component_reference'],"children",True): # generated from line 18, col 1
                    if VFSL([locals()]+SL+[globals(), builtin],"port.kind",True) == 'Subscriber' or VFSL([locals()]+SL+[globals(), builtin],"port.kind",True) == 'Publisher': # generated from line 19, col 1
                        write(u'''    <port name="''')
                        _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"port",True),"properties",True)['name'] # u"$port.properties['name']" on line 20, col 17
                        if _v is not None: write(_filter(_v, rawExpr=u"$port.properties['name']")) # from line 20, col 17.
                        write(u'''">
      <uuid>''')
                        _v = VFSL([locals()]+SL+[globals(), builtin],"port_uuids",True)[VFN(VFSL([locals()]+SL+[globals(), builtin],"port",True),"properties",True)['name']] # u"$port_uuids[$port.properties['name']]" on line 21, col 13
                        if _v is not None: write(_filter(_v, rawExpr=u"$port_uuids[$port.properties['name']]")) # from line 21, col 13.
                        write(u'''</uuid>
      <profile>
''')
                        _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"port",True),"properties",True)['port_network_profile'] # u"$port.properties['port_network_profile']" on line 23, col 1
                        if _v is not None: write(_filter(_v, rawExpr=u"$port.properties['port_network_profile']")) # from line 23, col 1.
                        write(u'''
      </profile>
''')
                        if VFSL([locals()]+SL+[globals(), builtin],"port.kind",True) == 'Subscriber': # generated from line 25, col 1
                            for p in VFN(VFSL([locals()]+SL+[globals(), builtin],"project",True),"getChildrenByKind",False)('Publisher'): # generated from line 26, col 1
                                if VFN(VFSL([locals()]+SL+[globals(), builtin],"p",True),"properties",True)['message_reference'] == VFN(VFSL([locals()]+SL+[globals(), builtin],"port",True),"properties",True)['message_reference']: # generated from line 27, col 1
                                    write(u'''      <sender uuid="''')
                                    _v = VFSL([locals()]+SL+[globals(), builtin],"port_uuids",True)[VFN(VFSL([locals()]+SL+[globals(), builtin],"p",True),"properties",True)['name']] # u"$port_uuids[$p.properties['name']]" on line 28, col 21
                                    if _v is not None: write(_filter(_v, rawExpr=u"$port_uuids[$p.properties['name']]")) # from line 28, col 21.
                                    write(u'''">
\t<profile>
''')
                                    _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"p",True),"properties",True)['port_network_profile'] # u"$p.properties['port_network_profile']" on line 30, col 1
                                    if _v is not None: write(_filter(_v, rawExpr=u"$p.properties['port_network_profile']")) # from line 30, col 1.
                                    write(u'''
\t</profile>
      </sender>
''')
                        write(u'''    </port>
''')
                if VFSL([locals()]+SL+[globals(), builtin],"comp_instance.children",True) != []: # generated from line 39, col 1
                    for port_instance in VFSL([locals()]+SL+[globals(), builtin],"comp_instance.children",True): # generated from line 40, col 1
                        write(u'''    <port_instance name="''')
                        _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["name"] # u'$port_instance.properties["name"]' on line 41, col 26
                        if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["name"]')) # from line 41, col 26.
                        write(u'''">
      <port name="''')
                        _v = VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["port_reference"],"properties",True)["name"] # u'$port_instance.properties["port_reference"].properties["name"]' on line 42, col 19
                        if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["port_reference"].properties["name"]')) # from line 42, col 19.
                        write(u'''"/>
      <group setting="''')
                        _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"port_instance",True),"properties",True)["group"] # u'$port_instance.properties["group"]' on line 43, col 23
                        if _v is not None: write(_filter(_v, rawExpr=u'$port_instance.properties["group"]')) # from line 43, col 23.
                        write(u'''"/>
    </port_instance>
''')
