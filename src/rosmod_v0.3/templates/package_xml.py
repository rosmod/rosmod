...
__CHEETAH_genTime__ = 1440176560.964735
__CHEETAH_genTimestamp__ = 'Fri Aug 21 12:02:40 2015'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod-gui/src/rosmod_v0.3/templates/package_xml.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jul 17 22:14:16 2015'
...
<package>
  <name>''')
        _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 3, col 9
        if _v is not None: write(_filter(_v, rawExpr=u'$package_name')) # from line 3, col 9.
        write(u'''</name>
  <version>0.0.0</version>
  <description>The ''')
        _v = VFFSL(SL,"package_name",True) # u'$package_name' on line 5, col 20
