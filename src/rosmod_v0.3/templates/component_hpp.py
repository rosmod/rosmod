...
__CHEETAH_genTime__ = 1441230648.598752
__CHEETAH_genTimestamp__ = 'Wed Sep  2 16:50:48 2015'
__CHEETAH_src__ = '/home/jeb/Repositories/rosmod-gui/src/rosmod_v0.3/templates/component_hpp.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Sep  2 16:33:34 2015'
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"subscribers",True)) > 0: # generated from line 91, col 1
            if VFSL([locals()]+SL+[globals(), builtin],"trafficGen",True): # generated from line 92, col 1
                write(u'''  // callback func for when servers are done receiving data
  void mw_recv_done_callback(Network::receiver* receiver_mw);
''')
            for sub in VFSL([locals()]+SL+[globals(), builtin],"subscribers",True): # generated from line 96, col 1
                write(u'''  // Subscriber
  ros''')
                _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 98, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 98, col 6.
                write(u'''::Subscriber ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"sub",True),"properties",True)["name"] # u'$sub.properties["name"]' on line 98, col 25
...
''')
  ...
  uint64_t ''')
                    _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 101, col 12
                    if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 101, col 12.
                    write(u'''_id;
  // subscriber receiver middleware
  Network::receiver ''')
                    _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"sub",True),"properties",True)['name'] # u"${sub.properties['name']}" on line 103, col 21
                    if _v is not None: write(_filter(_v, rawExpr=u"${sub.properties['name']}")) # from line 103, col 21.
                    write(u'''_recv_mw;
''')
                write(u'''
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"publishers",True)) > 0: # generated from line 108, col 1
            if VFSL([locals()]+SL+[globals(), builtin],"trafficGen",True): # generated from line 109, col 1
                write(u'''  // do we abide by the profiles?
  bool tg_misbehave;
  // size of messages generated
  uint64_t max_data_length;
''')
            for pub in VFSL([locals()]+SL+[globals(), builtin],"publishers",True): # generated from line 115, col 1
                write(u'''  // Publisher 
  ros''')
                _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 117, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 117, col 6.
                write(u'''::Publisher ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"pub",True),"properties",True)["name"] # u'$pub.properties["name"]' on line 117, col 24
                if _v is not None: write(_filter(_v, rawExpr=u'$pub.properties["name"]')) # from line 117, col 24.
                write(u''';
''')
                if VFSL([locals()]+SL+[globals(), builtin],"trafficGen",True): # generated from line 118, col 1
                    write(u'''  // Timer for generating traffic
  ros::Timer ''')
                    _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 120, col 14
  ...
  void ''')
                    _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 122, col 8
  ...
  Network::sender ''')
                    _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"pub",True),"properties",True)['name'] # u"${pub.properties['name']}" on line 124, col 19
                    if _v is not None: write(_filter(_v, rawExpr=u"${pub.properties['name']}")) # from line 124, col 19.
                    write(u'''_send_mw;
''')
                write(u'''
''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"provided_services",True)) > 0: # generated from line 129, col 1
            for server in VFSL([locals()]+SL+[globals(), builtin],"servers",True): # generated from line 130, col 1
                write(u'''  // Server 
  ros''')
                _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 132, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 132, col 6.
                write(u'''::ServiceServer ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"server",True),"properties",True)["name"] # u'${server.properties["name"]}' on line 132, col 28
                if _v is not None: write(_filter(_v, rawExpr=u'${server.properties["name"]}')) # from line 132, col 28.
                write(u''';

''')
        if VFSL([locals()]+SL+[globals(), builtin],"len",False)(VFSL([locals()]+SL+[globals(), builtin],"required_services",True)) > 0: # generated from line 136, col 1
            for client in VFSL([locals()]+SL+[globals(), builtin],"clients",True): # generated from line 137, col 1
                write(u'''  // Client 
  ros''')
                _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 139, col 6
                if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 139, col 6.
                write(u'''::ServiceClient ''')
                _v = VFN(VFSL([locals()]+SL+[globals(), builtin],"client",True),"properties",True)["name"] # u'$client.properties["name"]' on line 139, col 28
                if _v is not None: write(_filter(_v, rawExpr=u'$client.properties["name"]')) # from line 139, col 28.
                write(u''';

''')
        if VFSL([locals()]+SL+[globals(), builtin],"user_private_variables",True) == "": # generated from line 143, col 1
...
''')
            ...
            write(u'''  //# Start User Private Variables Marker
''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"user_private_variables",True) # u'$user_private_variables' on line 148, col 1
