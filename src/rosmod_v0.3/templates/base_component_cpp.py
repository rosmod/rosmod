...
__CHEETAH_genTime__ = 1437012722.964227
...
__CHEETAH_srcLastModified__ = 'Wed Jul 15 21:08:13 2015'
...
void Component::Init(const ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 23, col 31
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 23, col 31.
...
void Component::processQueue() {  
  ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 30, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 30, col 6.
