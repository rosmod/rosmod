...
__CHEETAH_genTime__ = 1437152919.049953
...
__CHEETAH_srcLastModified__ = 'Thu Jul 16 10:49:29 2015'
...
''')
        if VFFSL(SL,"mod",True) != "": # generated from line 14, col 1
...
void Component::Init(const ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 31, col 31
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 31, col 31.
...
void Component::processQueue() {  
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 38, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 38, col 6.
