...
__CHEETAH_genTime__ = 1436979669.064243
__CHEETAH_genTimestamp__ = 'Wed Jul 15 12:01:09 2015'
__CHEETAH_src__ = '/home/jeb/Repositores/rosmod-gui/src/rosmod_v0.3/templates/base_component_cpp.tmpl'
...
void Component::Init(const ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 21, col 31
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 21, col 31.
        write(u'''::TimerEvent& event) {}

// Callback Queue Handler
void Component::processQueue() {  
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 25, col 6
        if _v is not None: write(_filter(_v, rawExpr=u'${mod}')) # from line 25, col 6.
