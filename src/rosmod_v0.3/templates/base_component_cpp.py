...
__CHEETAH_genTime__ = 1440180608.712139
...
__CHEETAH_srcLastModified__ = 'Mon Aug  3 12:04:57 2015'
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"mod",True) != "": # generated from line 15, col 1
...
void Component::Init(const ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 32, col 31
...
void Component::processQueue() {  
  ros''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"mod",True) # u'${mod}' on line 39, col 6
