...
__CHEETAH_genTime__ = 1437060493.314223
...
__CHEETAH_srcLastModified__ = 'Thu Jul 16 10:22:54 2015'
...
void Component::Init(const ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 23, col 31
...
void Component::processQueue() {  
  ros''')
        _v = VFFSL(SL,"mod",True) # u'${mod}' on line 30, col 6
