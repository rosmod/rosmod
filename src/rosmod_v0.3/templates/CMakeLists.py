...
__CHEETAH_genTime__ = 1441843120.660705
...
__CHEETAH_srcLastModified__ = 'Mon Sep  7 15:17:08 2015'
...
''')
        if VFFSL(SL,"needs_io",True): # generated from line 245, col 1
            if 'KSP' in VFFSL(SL,"io_types",True): # generated from line 246, col 1
...
''')
            if 'SUMO' in VFFSL(SL,"io_types",True): # generated from line 256, col 1
                write(u'''include_directories(include ''')
                _v = VFFSL(SL,"catkin_INCLUDE_DIRS",True) # u'${catkin_INCLUDE_DIRS}' on line 257, col 29
                if _v is not None: write(_filter(_v, rawExpr=u'${catkin_INCLUDE_DIRS}')) # from line 257, col 29.
                write(u'''
\tinclude/sumo
)
add_library(sumo
