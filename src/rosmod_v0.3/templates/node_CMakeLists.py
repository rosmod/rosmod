...
__CHEETAH_genTime__ = 1436979669.178686
__CHEETAH_genTimestamp__ = 'Wed Jul 15 12:01:09 2015'
__CHEETAH_src__ = '/home/jeb/Repositores/rosmod-gui/src/rosmod_v0.3/templates/node_CMakeLists.tmpl'
...
include_directories(include ''')
        _v = VFFSL(SL,"catkin_INCLUDE_DIRS",True) # u'${catkin_INCLUDE_DIRS}' on line 176, col 29
...
target_link_libraries(node_main dl ''')
        _v = VFFSL(SL,"catkin_LIBRARIES",True) # u'${catkin_LIBRARIES}' on line 181, col 36
